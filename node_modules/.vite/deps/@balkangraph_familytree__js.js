...
var require_familytree = __commonJS({
  "node_modules/@balkangraph/familytree.js/familytree.js"(exports, module) {
    var FamilyTree = function(e, t) {
      ...
      this._event_id = FamilyTree._guid(), FamilyTree._validateConfig(this.config) && (this._vScroll = {}, this.config.ui || (this.ui = FamilyTree.ui), this.config.editUI ? this.editUI = this.config.editUI : this.editUI = new FamilyTree.editUI(), this.editUI.init(this), this.config.filterUI ? this.filterUI = this.config.filterUI : this.filterUI = new FamilyTree.filterUI(), this.filterUI.init(this), this.manager = new FamilyTree.manager(this), this.config.searchUI ? this.searchUI = this.config.searchUI : this.searchUI = new FamilyTree.searchUI(), this.config.nodeMenuUI ? this.nodeMenuUI = this.config.nodeMenuUI : this.nodeMenuUI = new FamilyTree.menuUI(), this.nodeMenuUI.init(this, this.config.nodeMenu), this.config.nodeCircleMenuUI ? this.nodeCircleMenuUI = this.config.nodeCircleMenuUI : this.nodeCircleMenuUI = new FamilyTree.circleMenuUI(), this.nodeCircleMenuUI.init(this, this.config.nodeCircleMenu), this.config.nodeContextMenuUI ? this.nodeContextMenuUI = this.config.nodeContextMenuUI : this.nodeContextMenuUI = new FamilyTree.menuUI(), this.nodeContextMenuUI.init(this, this.config.nodeContextMenu), this.config.toolbarUI ? this.toolbarUI = this.config.toolbarUI : this.toolbarUI = new FamilyTree.toolbarUI(), this.config.notifierUI ? this.notifierUI = this.config.notifierUI : this.notifierUI = new FamilyTree.notifierUI(), this.notifierUI.init(this), this.config.menuUI ? this.menuUI = this.config.menuUI : this.menuUI = new FamilyTree.menuUI(), this.menuUI.init(this, this.config.menu), this.config.xScrollUI || (this.xScrollUI = new FamilyTree.xScrollUI(this.element, this.config, function() {
        ...
        i._draw(true, FamilyTree.action.xScroll);
        ...
        i._draw(true, FamilyTree.action.xScroll);
      })), this.config.undoRedoUI ? this.undoRedoUI = this.config.undoRedoUI : this.undoRedoUI = new FamilyTree.undoRedoUI(), this.element.classList.add("bft-" + this.config.mode), this._gragStartedId = null, this._timeout = null, this._touch = null, this._initialized = false, this._loaded = false, this._moveInterval = null, this._movePosition = null, this.response = null, this.nodes = null, this.isVisible = null, FamilyTree._intersectionObserver(this.element, function(e2) {
        i.isVisible = e2, false !== FamilyTree.events.publish("visibility-change", [i]) && FamilyTree.LAZY_LOADING && i.isVisible && (i._loaded ? i._draw(false, FamilyTree.action.update) : (i._setInitialSizeIfNotSet(), i._draw(false, FamilyTree.action.init)));
      }));
    };
    FamilyTree._defaultConfig = function(e) {
      return { interactive: true, mode: "light", lazyLoading: true, enableDragDrop: false, enableSearch: true, enableTouch: false, enablePan: true, keyNavigation: false, miniMap: false, nodeMenu: null, nodeCircleMenu: null, nodeContextMenu: null, menu: null, toolbar: false, sticky: true, nodeMouseClick: FamilyTree.action.details, nodeMouseDbClick: FamilyTree.none, mouseScrool: FamilyTree.action.zoom, showXScroll: FamilyTree.none, showYScroll: FamilyTree.none, template: "ana", tags: {}, min: false, nodeBinding: {}, linkBinding: {}, searchFields: null, searchDisplayField: null, searchFieldsWeight: null, searchFieldsAbbreviation: null, nodes: [], clinks: [], slinks: [], backdrops: [], groupDottedLines: [], dottedLines: [], undoRedoStorageName: null, levelSeparation: 60, siblingSeparation: 20, subtreeSeparation: 40, backdropSeparation: 15, mixedHierarchyNodesSeparation: 15, assistantSeparation: 100, minPartnerSeparation: 50, partnerChildrenSplitSeparation: 20, partnerNodeSeparation: 15, columns: 10, padding: 30, orientation: FamilyTree.orientation.top, layout: FamilyTree.layout.normal, layoutGridColumns: "dynamic", scaleInitial: 1, movable: null, scaleMin: 0.1, scaleMax: 5, orderBy: null, editUI: null, filterUI: null, searchUI: null, xScrollUI: null, yScrollUI: null, nodeMenuUI: null, nodeCircleMenuUI: null, nodeContextMenuUI: null, toolbarUI: null, notifierUI: null, menuUI: null, undoRedoUI: null, exportUrl: "https://balkan.app/export", collapse: {}, expand: {}, align: FamilyTree.CENTER, UI: null, anim: { func: FamilyTree.anim.outPow, duration: 200 }, zoom: { speed: 120, smooth: 12 }, roots: null, state: null, editForm: { readOnly: false, titleBinding: "name", photoBinding: "img", addMore: "Add more fields", addMoreBtn: "Add", addMoreFieldName: "Field name", saveAndCloseBtn: "Save and close", cancelBtn: "Cancel", generateElementsFromFields: true, focusBinding: null, buttons: { edit: { icon: FamilyTree.icon.edit(24, 24, "#fff"), text: "Edit", hideIfEditMode: true, hideIfDetailsMode: false }, share: { icon: FamilyTree.icon.share(24, 24, "#fff"), text: "Share" }, pdf: { icon: FamilyTree.icon.pdf(24, 24, "#fff"), text: "Save as PDF" }, remove: { icon: FamilyTree.icon.remove(24, 24, "#fff"), text: "Remove", hideIfDetailsMode: true } }, elements: [] } };
    }, FamilyTree.prototype.load = function(e, t) {
      var i = this;
      return this.config.nodes = e, this._draw(false, FamilyTree.action.init, void 0, function() {
      ...
      null == e && (e = FamilyTree.action.update), this._draw(false, e, t, i);
      ...
      if (!FamilyTree.LAZY_LOADING || this.isVisible) if (FamilyTree.LAZY_LOADING || this._initialized || (this._setInitialSizeIfNotSet(), 0 != this.width() && 0 != this.height())) {
        ...
        this.manager.read(e, this.width(), this.height(), n, t, i, function(e2) {
          if (!a.notifierUI.show(e2.notif)) {
            t != FamilyTree.action.exporting && (a.nodes = e2.nodes, a.visibleNodeIds = e2.visibleNodeIds, a.roots = e2.roots), a.editUI.fields = e2.allFields;
            var n2 = { defs: "" };
            FamilyTree.events.publish("renderdefs", [a, n2]);
            var o = a.ui.defs(n2.defs), l = a.getScale(e2.viewBox);
            o += a.ui.pointer(a.config, t, l);
            var s = a.getViewBox(), d = e2.viewBox;
            n2 = { content: o, res: e2 };
            FamilyTree.events.publish("prerender", [a, n2]), o = n2.content;
            var c = [];
            if (FamilyTree.RENDER_LINKS_BEFORE_NODES) for (var m = 0; m < e2.visibleNodeIds.length; m++) {
              var h = e2.nodes[e2.visibleNodeIds[m]];
              FamilyTree.getRootOf(h).stParent ? c.push(h.id) : o += a.ui.link(h, a, l, e2.bordersByRootIdAndLevel, e2.nodes, t);
            }
            for (m = 0; m < e2.visibleNodeIds.length; m++) {
              h = e2.nodes[e2.visibleNodeIds[m]];
              var p = a._get(h.id);
              FamilyTree.RENDER_LINKS_BEFORE_NODES && c.includes(h.id) && (o += a.ui.link(h, a, l, e2.bordersByRootIdAndLevel, e2.nodes, t)), o += a.ui.node(h, p, e2.animations, a.config, void 0, void 0, void 0, t, l, a);
            }
            for (m = 0; m < e2.visibleNodeIds.length; m++) {
              h = e2.nodes[e2.visibleNodeIds[m]];
              FamilyTree.RENDER_LINKS_BEFORE_NODES || (o += a.ui.link(h, a, l, e2.bordersByRootIdAndLevel, e2.nodes, t)), o += a.ui.expandCollapseBtn(a, h, a._layoutConfigs, t, l);
            }
            n2 = { content: o, res: e2 };
            if (FamilyTree.events.publish("render", [a, n2]), o = n2.content, e2 = n2.res, o += a.ui.lonely(a.config), t !== FamilyTree.action.exporting) {
              t !== FamilyTree.action.centernode && t !== FamilyTree.action.insert && t !== FamilyTree.action.expand && t !== FamilyTree.action.collapse && t !== FamilyTree.action.update || (d = s), t === FamilyTree.action.init && null != s && (d = s), a.response = e2;
              ...
              var y = false, g = a.response.animations;
              if (g[0].length > 0) {
                ...
                FamilyTree.animate(g[0], g[1], g[2], a.config.anim.duration, a.config.anim.func, function() {
                  y || (r && r(), FamilyTree.events.publish("redraw", [a]), a._showAfterAnimation(), y = true);
                });
              }
              t === FamilyTree.action.centerNode ? FamilyTree.animate(a.getSvg(), { viewbox: s }, { viewbox: a.response.viewBox }, a.config.anim.duration, a.config.anim.func, function() {
                a.ripple(i.options.rippleId), y || (r && r(), FamilyTree.events.publish("redraw", [a]), a._showAfterAnimation(), y = true);
              }, function() {
                a.xScrollUI.setPosition(), a.yScrollUI.setPosition();
              }) : !s || !a.response || s[0] == a.response.viewBox[0] && s[1] == a.response.viewBox[1] && s[2] == a.response.viewBox[2] && s[3] == a.response.viewBox[3] || t !== FamilyTree.action.insert && t !== FamilyTree.action.expand && t !== FamilyTree.action.collapse && t !== FamilyTree.action.update && t !== FamilyTree.action.init ? 0 == g[0].length && (y || (r && r(), FamilyTree.events.publish("redraw", [a]), y = true)) : FamilyTree.animate(a.getSvg(), { viewbox: s }, { viewbox: a.response.viewBox }, 2 * a.config.anim.duration, a.config.anim.func, function() {
                a.xScrollUI.setPosition(), a.yScrollUI.setPosition(), y || (r && r(), FamilyTree.events.publish("redraw", [a]), y = true);
              }), a._initialized || (a._initialized = true, a.filterUI.update(), FamilyTree.events.publish("init", [a])), !a._loaded && e2 && e2.nodes && Object.keys(e2.nodes).length && (a._loaded = true);
            } else {
              var v = e2.boundary, T = v.maxX - v.minX, b = v.maxY - v.minY, F = a.ui.svg(T, b, [v.minX, v.minY, T, b], a.config, o, l);
              r(F, e2);
            }
          }
        }, function(e2) {
          FamilyTree.events.publish("ready", [a, e2]);
        });
      ...
      if (null != r) {
        ...
        if (null != a) {
          ...
          FamilyTree.events.publish("ripple", [this, T]), y.setAttribute("x", T.ripple.rect ? T.ripple.rect.x : 0), y.setAttribute("y", T.ripple.rect ? T.ripple.rect.y : 0), y.setAttribute("width", T.ripple.rect ? T.ripple.rect.width : r.w), y.setAttribute("height", T.ripple.rect ? T.ripple.rect.height : r.h), y.setAttribute("rx", T.ripple.radius), y.setAttribute("ry", T.ripple.radius), g.setAttribute("clip-path", "url(#" + v + ")"), g.setAttribute("cx", o), g.setAttribute("cy", l), g.setAttribute("r", 0), g.setAttribute("fill", T.ripple.color), g.setAttribute("class", "bft-ripple"), u.appendChild(y), f.appendChild(u), f.appendChild(g), a.appendChild(f), FamilyTree.animate(g, { r: 0, opacity: 1 }, { r: p, opacity: 0 }, 500, FamilyTree.anim.outPow, function() {
            a.removeChild(f);
          });
        }
      }
    }, FamilyTree.prototype.center = function(e, t, i) {
      var r, a, n = e, o = true, l = true;
      ...
      this._draw(false, FamilyTree.action.centerNode, { id: e, options: s }, i);
    }, FamilyTree.prototype.fit = function(e) {
      this.config.scaleInitial = FamilyTree.match.boundary, this._draw(true, FamilyTree.action.init, { method: "fit" }, e);
      ...
      t || (t = "base"), this._layoutConfigs[t].layout = e, "base" == t && (this.config.layout = e), this._draw(false, FamilyTree.action.update);
    }, FamilyTree.prototype.setOrientation = function(e, t, i) {
      var r = this;
      t || (t = "base"), this._layoutConfigs[t].orientation = e, "base" == t && (this.config.orientation = e), this._draw(false, FamilyTree.action.update, void 0, function() {
        FamilyTree._moveToBoundaryArea(r.getSvg(), r.getViewBox(), r.response.boundary, function() {
          r._draw(true, FamilyTree.action.pan), i && i();
        });
      });
      ...
      var i = this;
      return this.config.nodes = e, this.config.roots = null, this._draw(false, FamilyTree.action.init, void 0, function() {
        i.filterUI.update(), t && t();
      }), this;
      ...
      return i ? (i.rids.sort(function(e2, i2) {
        var r = t.indexOf(e2), a = t.indexOf(i2);
      ...
      if (t) {
        if ((t = new Date(t)) < /* @__PURE__ */ new Date()) {
      ...
      } else (t = /* @__PURE__ */ new Date()).setDate(t.getDate() + 5), t = t.toISOString(), localStorage.setItem("to_date", t);
      return localStorage.getItem(e);
    }, FamilyTree.localStorage.setItem = function(e, t) {
      try {
        localStorage.setItem(e, t);
      } catch (e2) {
        e2.code == e2.QUOTA_EXCEEDED_ERR ? (console.warn("Local storage quota exceeded"), localStorage.clear()) : (console.error("Local storage error code:" + e2.code), console.error(e2));
      }
    }, FamilyTree.prototype.canUpdateLink = function(e, t) {
      if (null == t || null == t) return false;
      if (null == e || null == e) return false;
      if (e == t) return false;
      ...
      if (true === i && false === FamilyTree.events.publish("update", [this, a, e])) return false;
      this.update(e), FamilyTree.events.publish("updated", [this]), this.filterUI.update();
      var n = this.getNode(e.id), o = n.pid;
      null == o && (o = n.stpid), this._draw(false, FamilyTree.action.update, { id: o }, function() {
        r.ripple(e.id), t && t();
      });
      ...
      var r = this;
      if (!this.canRemove(e)) return false;
      var a = this._getNewPidsAndStpidsForIds(e);
      if (true === i && false === FamilyTree.events.publish("remove", [this, e, a])) return false;
      return this.remove(e), FamilyTree.events.publish("updated", [this]), this.filterUI.update(), this._draw(false, FamilyTree.action.update, null, function() {
      ...
      var r = this;
      if (true === i && false === FamilyTree.events.publish("add", [this, e])) return false;
      this.add(e), FamilyTree.events.publish("updated", [this]), this.filterUI.update(), r._draw(false, FamilyTree.action.insert, { id: e.pid, insertedNodeId: e.id }, function() {
        r.ripple(e.id), t && t();
      });
      ...
      this._replaceIds(e), this._draw(false, FamilyTree.action.update, void 0, t);
    }, FamilyTree.prototype._replaceIds = function(e) {
      for (var t = function(t2) {
        for (var i2 = 0; i2 < t2.length; i2++) {
          var r2 = t2[i2];
          for (var a2 in e) {
            var n2 = e[a2];
            r2.from == a2 && (r2.from = n2), r2.to == a2 && (r2.to = n2);
          }
        }
      ...
      if (!e || FamilyTree.isNEU(e.mid) && FamilyTree.isNEU(e.fid)) console.error("addSonNode invalid data");
        ...
        if (true === i) {
          if (false === FamilyTree.events.publish("update", [this, a])) return false;
        }
        r._fireUpdate_addUpdateRemove(a, i);
        var n = "";
        FamilyTree.isNEU(a.addNodesData[0].pid) ? FamilyTree.isNEU(a.addNodesData[0].mid) ? FamilyTree.isNEU(a.addNodesData[0].fid) || (n = a.addNodesData[0].fid) : n = a.addNodesData[0].mid : n = a.addNodesData[0].pid, r._draw(false, FamilyTree.action.insert, { id: n, insertedNodeId: a.addNodesData[0].id }, function() {
          r.ripple(a.addNodesData[0].id), t && t(), true === i && FamilyTree.events.publish("updated", [r, a]), r.filterUI.update();
        });
      }
      ...
      if (!t || FamilyTree.isNEU(t.mid) && FamilyTree.isNEU(t.fid)) console.error("addChildAndPartnerNodes invalid childData");
        ...
        if (true === a) {
          if (false === FamilyTree.events.publish("update", [this, s])) return false;
        }
        ...
        var c = "";
        l ? c = l.id : FamilyTree.isNEU(t.pid) ? FamilyTree.isNEU(t.mid) ? FamilyTree.isNEU(t.fid) || (c = t.fid) : c = t.mid : c = t.pid, n._draw(false, FamilyTree.action.update, { id: c }, function() {
          n.ripple(t.id), n.ripple(i.id), r && r(), true === a && FamilyTree.events.publish("updated", [n, s]), n.filterUI.update();
        }), true === a && FamilyTree.events.publish("updating", [n, s]);
      ...
      if (!FamilyTree.isNEU(t) && t.length) if (i) {
        ...
        if (true === a) {
          if (false === FamilyTree.events.publish("update", [this, c])) return false;
        }
        ...
        var h = "";
        d && (h = d.id), n._draw(false, FamilyTree.action.update, { id: h }, function() {
          n.ripple(i.id), r && r(), true === a && FamilyTree.events.publish("updated", [n, c]), n.filterUI.update();
        }), true === a && FamilyTree.events.publish("updating", [n, c]);
      ...
      if (e && Array.isArray(e.pids) && 1 == e.pids.length) {
        ...
        if (true === i) {
          if (false === FamilyTree.events.publish("update", [this, n])) return false;
        }
        ...
        r._draw(false, FamilyTree.action.insert, { id: l, insertedNodeId: n.addNodesData[0].id }, function() {
          r.ripple(n.addNodesData[0].id), t && t(), true === i && FamilyTree.events.publish("updated", [r, n]), r.filterUI.update();
        }), true === i && FamilyTree.events.publish("updating", [r, n]);
      ...
      if (i) {
        if (["mid", "fid"].has(t)) if (FamilyTree.isNEU(e)) console.error("addParentNode invalid childId");
          ...
          if (true === a) {
            if (false === FamilyTree.events.publish("update", [this, d])) return false;
          }
          n._fireUpdate_addUpdateRemove(d, a);
          var c = e;
          n.config.roots = [d.addNodesData[0].id], n._draw(false, FamilyTree.action.insert, { id: c, insertedNodeId: d.addNodesData[0].id }, function() {
            n.ripple(d.addNodesData[0].id), r && r(), true === a && FamilyTree.events.publish("updated", [n, d]), n.filterUI.update();
          }), true === a && FamilyTree.events.publish("updating", [n, d]);
        }
      ...
      var t = this.getNode(e);
      if (!t) return false;
      var i = this.getNode(t.mid), r = this.getNode(t.fid), a = t.ftChildrenIds.length > 0, n = false, o = t.pids.length > 0, l = t.pids.length > 1;
      if (1 == t.pids.length) {
      ...
      if (this.canRemove(e)) {
        ...
        r._fireUpdate_addUpdateRemove(c, i), -1 != (d = r.config.roots.indexOf(e)) && r.config.roots.splice(d, 1), r._draw(false, FamilyTree.action.update, null, function() {
          r.config.sticky && FamilyTree._moveToBoundaryArea(r.getSvg(), r.getViewBox(), r.response.boundary), t && t(), true === i && FamilyTree.events.publish("updated", [r, c]), r.filterUI.update();
        }), true === i && FamilyTree.events.publish("updating", [r, c]);
      }
      ...
      if (true === i && false === FamilyTree.events.publish("update", [this, d])) return false;
      r._fireUpdate_addUpdateRemove(d, i), r._draw(false, FamilyTree.action.update, null, function() {
        r.config.sticky && FamilyTree._moveToBoundaryArea(r.getSvg(), r.getViewBox(), r.response.boundary), t && t(), true === i && FamilyTree.events.publish("updated", [r, d]), r.filterUI.update();
      });
      ...
      FamilyTree.isNEU(e.removeNodeId) || this.remove(e.removeNodeId), true === t && FamilyTree.events.publish("updating", [this, e]);
      ...
      n.onload = function(e2) {
        4 == n.readyState && 200 === this.status && (null == e2.target ? a(this.response) : a(e2.target.response));
      ...
      return e < 0 ? 0 : e > 1 ? 1 : e < 1 / 2.75 ? 1 - 7.5625 * e * e : e < 2 / 2.75 ? 1 - (7.5625 * (e - 1.5 / 2.75) * (e - 1.5 / 2.75) + 0.75) : e < 2.5 / 2.75 ? 1 - (7.5625 * (e - 2.25 / 2.75) * (e - 2.25 / 2.75) + 0.9375) : 1 - (7.5625 * (e - 2.625 / 2.75) * (e - 2.625 / 2.75) + 0.984375);
      ...
      if (this.hide(), false === FamilyTree.events.publish("show", [this, e])) return false;
      var r = this, a = this.content(e, t, i);
      this.obj.element.appendChild(a.element), FamilyTree.input.init(this.obj.element), i ? t || this._focusElement(a.focusId) : this.interval = FamilyTree.animate(a.element, { right: -20, opacity: 0 }, { right: 0, opacity: 1 }, 300, FamilyTree.anim.outSin, function() {
        t || r._focusElement(a.focusId);
      }), this.obj.element.querySelector("[data-edit-from-close]").addEventListener("click", function(t2) {
        t2.preventDefault(), false !== FamilyTree.events.publish("cancel", [r, { id: e }]) && r.hide();
      }), this.obj.element.querySelector("[data-edit-from-cancel]").addEventListener("click", function(t2) {
        t2.preventDefault(), false !== FamilyTree.events.publish("cancel", [r, { id: e }]) && r.hide();
      }), this.obj.element.querySelector("[data-edit-from-save]").addEventListener("click", function(t2) {
        t2.preventDefault();
        var i2 = FamilyTree.input.validateAndGetData(a.element);
        if (false !== i2) {
          var n2 = r.obj.get(e), o2 = { data: FamilyTree.mergeDeep(n2, i2) };
          if (false === FamilyTree.events.publish("save", [r, o2])) return;
          r.obj.updateNode(o2.data, null, true), r.hide();
        }
      });
      for (var n = this.obj.element.querySelectorAll("[data-input-btn]"), o = 0; o < n.length; o++) {
        n[o].addEventListener("click", function(t2) {
          t2.preventDefault(), FamilyTree.events.publish("element-btn-click", [r, { input: this.parentNode.querySelector("input"), nodeId: e, event: t2 }]);
        });
      }
      this.obj.element.querySelector("[data-add-more-fields-btn]").addEventListener("click", function(e2) {
        e2.stopPropagation(), e2.preventDefault();
        var t2 = this, i2 = FamilyTree.elements.textbox({}, { type: "textbox", label: r.obj.config.editForm.addMoreFieldName, btn: r.obj.config.editForm.addMoreBtn }, "280px");
        t2.parentNode.insertAdjacentHTML("beforebegin", i2.html), t2.style.display = "none", FamilyTree.input.init(t2.parentNode.previousSibling);
        var a2 = document.getElementById(i2.id);
        a2.focus(), a2.nextElementSibling.addEventListener("click", function(e3) {
          e3.stopPropagation(), e3.preventDefault();
          var i3 = a2.value, n2 = r.obj.element.querySelector('[data-binding="' + FamilyTree._escapeDoubleQuotes(a2.value) + '"]');
          if (FamilyTree.isNEU(i3) || n2) a2.focus();
          else {
            var o2 = FamilyTree.elements.textbox({}, { type: "textbox", label: i3, binding: i3 }, "280px");
            a2.parentNode.parentNode.parentNode.removeChild(a2.parentNode.parentNode), t2.parentNode.insertAdjacentHTML("beforebegin", o2.html), t2.style.display = "", FamilyTree.input.init(t2.parentNode.previousSibling), document.getElementById(o2.id).focus();
          }
        });
      }), this.obj.element.querySelector("[data-bft-edit-from-btns]").addEventListener("click", function(t2) {
        for (var i2 = t2.target; i2 && i2.hasAttribute && !i2.hasAttribute("data-edit-from-btn"); ) i2 = i2.parentNode;
        if (i2 && i2.hasAttribute) {
          var n2 = i2.getAttribute("data-edit-from-btn"), o2 = { button: r.obj.config.editForm.buttons[n2], name: n2, nodeId: e, event: t2 };
          if (false === FamilyTree.events.publish("button-click", [r, o2])) return false;
          switch (n2) {
            case "edit":
              r.obj.editUI.show(e, false, true);
              break;
            case "pdf":
            ...
            case "share":
              ...
              break;
            case "remove":
              r.obj.removeNode(e, null, true), r.hide();
          }
        }
      });
      ...
      if (this.obj.config.editForm.generateElementsFromFields) for (var T = 0; T < this.fields.length; T++) {
        var b = this.fields[T];
        if ("tags" != b) {
          for (var F = false, x = 0; x < l.length; x++) {
      ...
      return I.innerHTML = `<div>
        ...
        for (var i2 in m) {
          var r2 = m[i2];
          FamilyTree.isNEU(r2) || (w && r2.hideIfEditMode || t && r2.hideIfDetailsMode || o && "Edit" == r2.text || (e2 += `<div data-edit-from-btn='${i2}' class="bft-img-button" ${C} title="${r2.text}">${r2.icon}</div>`));
        }
        return e2;
      }()}    
                        </div>
                    ...
                    <div class="bft-edit-form-fields">
                        <div class="bft-edit-form-fields-inner">
                            <div class="bft-form-fieldset">
                                ${function() {
        for (var e2 = "", i2 = 0; i2 < l.length; i2++) {
          var r2 = l[i2];
          if (Array.isArray(r2)) {
            e2 += '<div class="bft-form-field-100 bft-form-fieldset">';
            for (var a2 = 0; a2 < r2.length; a2++) {
              var o2 = r2[a2], s2 = FamilyTree.elements[o2.type](u, o2, "unset", t);
              !FamilyTree.isNEU(s2.id) && FamilyTree.isNEU(n) && FamilyTree.isNEU(s2.value) && (n = s2.id), FamilyTree.isNEU(s2.value) || N.push(`${o2.label}: ${s2.value}`), e2 += s2.html;
            }
            e2 += "</div>";
          } else {
            s2 = FamilyTree.elements[r2.type](u, r2, "280px", t);
            !FamilyTree.isNEU(s2.id) && FamilyTree.isNEU(n) && FamilyTree.isNEU(s2.value) && (n = s2.id), FamilyTree.isNEU(s2.value) || N.push(`${r2.label}: ${s2.value}`), e2 += s2.html;
          }
        }
        return e2;
      }()}
      ...
      if (false === FamilyTree.events.publish("hide", [this])) return false;
      ...
      if (false === FamilyTree.events.publish("show", [this, l])) return false;
      ...
      if ("" != o) {
        ...
        for (var f = this.wrapper.getElementsByTagName("div"), u = 0; u < f.length; u++) {
          (s = f[u]).addEventListener("click", function(e2) {
            var t2, o2 = this.getAttribute(FamilyTree.attr.item);
            if (void 0 === a[o2].onClick) if ("add" === o2) {
              var l2 = { id: n.obj.generateId(), pid: i };
              n.obj.addNode(l2, null, true);
            } else if ("edit" === o2) {
              var s2 = n.obj.getNode(i);
              n.obj.editUI.show(s2.id);
            } else if ("details" === o2) {
              s2 = n.obj.getNode(i);
              n.obj.editUI.show(s2.id, true);
            } else "remove" === o2 ? n.obj.removeNode(i, null, true) : "svg" === o2 ? n.obj.exportSVG({ filename: "FamilyTree.svg", expandChildren: false, nodeId: i }) : "pdf" === o2 ? n.obj.exportPDF({ filename: "FamilyTree.pdf", expandChildren: false, nodeId: i }) : "png" === o2 ? n.obj.exportPNG({ filename: "FamilyTree.png", expandChildren: false, nodeId: i }) : "csv" === o2 ? n.obj.exportCSV({ nodeId: i }) : "xml" === o2 ? n.obj.exportXML({ nodeId: i }) : "json" === o2 && n.obj.exportJSON({ nodeId: i });
            else t2 = a[o2].onClick.call(n.obj, i, r);
            0 != t2 && n.hide();
          });
        }
      }
      ...
      if (!FamilyTree.isNEU(a.nodeCircleMenuButton)) {
        ...
        if (FamilyTree.isNEU(p) || p.getAttribute(FamilyTree.attr.control_node_circle_menu_wrraper_id) != e) {
          ...
          if (this._menu = t, false === u) return false;
          ...
          for (var F in (p = document.createElementNS("http://www.w3.org/2000/svg", "g")).setAttribute(FamilyTree.attr.control_node_circle_menu_wrraper_id, e), p.setAttribute("transform", "matrix(1,0,0,1," + c + "," + m + ")"), n.appendChild(p), f.menu) {
            ...
            this._buttonsInterval.push(FamilyTree.animate(k, { transform: [1, 0, 0, 1, 0, 0] }, { transform: [1, 0, 0, 1, E, M] }, 250, FamilyTree.anim.outBack, function(e2) {
              var t2 = e2[0].getAttribute(FamilyTree.attr.control_node_circle_menu_name), r2 = e2[0].parentNode.getAttribute(FamilyTree.attr.control_node_circle_menu_wrraper_id);
              e2[0].addEventListener("mouseenter", function(e3) {
                FamilyTree.events.publish("mouseenter", [i, { from: r2, menuItem: f.menu[t2], menuItemName: t2, event: e3 }]);
              }), e2[0].addEventListener("mouseout", function(e3) {
                FamilyTree.events.publish("mouseout", [i, { from: r2, menuItem: f.menu[t2], menuItemName: t2, event: e3 }]);
              });
            }));
          }
          this._linesInterval.push(FamilyTree.animate(h[0], { x1: -a.nodeCircleMenuButton.radius / 2, y1: -6, x2: a.nodeCircleMenuButton.radius / 2, y2: -6 }, { x1: -7, y1: -7, x2: 7, y2: 7 }, 500, FamilyTree.anim.inOutSin)), this._linesInterval.push(FamilyTree.animate(h[1], { x1: -a.nodeCircleMenuButton.radius / 2, y1: 0, x2: a.nodeCircleMenuButton.radius / 2, y2: 0 }, { x1: 0, y1: 0, x2: 0, y2: 0 }, 500, FamilyTree.anim.inOutSin)), this._linesInterval.push(FamilyTree.animate(h[2], { x1: -a.nodeCircleMenuButton.radius / 2, y1: 6, x2: a.nodeCircleMenuButton.radius / 2, y2: 6 }, { x1: -7, y1: 7, x2: 7, y2: -7 }, 500, FamilyTree.anim.inOutSin));
        } else this.hide();
      }
      ...
      return FamilyTree.events.on(e, t, this._event_id), this;
    }, void 0 === FamilyTree && (FamilyTree = {}), FamilyTree.idb = { version: 1, dbName: "BALKAN", tableName: "familytree-js", keyPath: "id" }, FamilyTree.idb.db = null, FamilyTree.idb._open = function(e) {
      if (FamilyTree._browser().msie) e && e(false);
      else if ((navigator.userAgent.toLowerCase().indexOf("safari") > 0 || navigator.userAgent.toLowerCase().indexOf("firefox") > 0) && window.location !== window.parent.location) e && e(false);
      else {
        if (!window.indexedDB) return console.error("Your browser doesn't support a stable version of IndexedDB."), void (e && e(false));
        if (null == FamilyTree.idb.db) {
          var t = indexedDB.open(FamilyTree.idb.dbName, FamilyTree.idb.version);
          t.onerror = function(t2) {
            console.error("Cannot open database!"), e && e(false);
          }, t.onsuccess = function(t2) {
            FamilyTree.idb.db = t2.target.result, e && e(true);
          }, t.onupgradeneeded = function(e2) {
            var t2 = e2.target.result;
            t2.objectStoreNames.contains(FamilyTree.idb.tableName) && t2.deleteObjectStore(FamilyTree.idb.tableName);
            t2.createObjectStore(FamilyTree.idb.tableName, { keyPath: FamilyTree.idb.keyPath });
          };
        } else e && e(true);
      }
      ...
      FamilyTree.idb._open(function(i) {
        if (i) {
          ...
          r.onerror = function(e2) {
            console.error("Unable to retrieve data from database!"), t && t(false);
          }, r.onsuccess = function(e2) {
            r.result ? t && t(true, r.result) : t && t(null);
          };
        } else t && t(false);
      });
      ...
      FamilyTree.idb.read(e.id, function(i) {
        if (null == i) {
          ...
          r.onerror = function(e2) {
            console.error("Unable to add data to database!"), t && t(false);
          }, r.onsuccess = function(e2) {
            t && t(true);
          };
        } else t && t(i);
      ...
      FamilyTree.idb._open(function(i) {
        if (i) {
          ...
          r.onerror = function(e2) {
            console.error("Unable to put data to database!"), t && t(false);
          }, r.onsuccess = function(e2) {
            t && t(true);
          };
        } else t && t(false);
      ...
      if (t) {
        ...
        }), this.layouts && this.layouts.addEventListener("click", function(e2) {
          for (var t2 = e2.target; t2; ) {
            if (t2.hasAttribute && t2.hasAttribute(FamilyTree.attr.layout)) {
              t2 = t2.getAttribute(FamilyTree.attr.layout), l.obj.setLayout(FamilyTree.layout[t2]);
              break;
            }
            t2 = t2.parentNode;
          }
      ...
      this._visible = true, this.layoutBtn.style.transform = "rotate(180deg) translateX(0px) translateY(0px)", FamilyTree.animate(this.div, { bottom: this.obj.config.padding - 10 }, { bottom: this.obj.config.padding + 135 }, this.obj.config.anim.duration, this.obj.config.anim.func), FamilyTree.animate(this.layouts, { bottom: -145 }, { bottom: 0 }, this.obj.config.anim.duration, this.obj.config.anim.func);
    }, FamilyTree.toolbarUI.prototype.hideLayout = function() {
      this._visible = false, this.layoutBtn.style.transform = "rotate(0deg) translateX(0px) translateY(0px)", FamilyTree.animate(this.div, { bottom: this.obj.config.padding + 135 }, { bottom: this.obj.config.padding - 10 }, this.obj.config.anim.duration, this.obj.config.anim.func), FamilyTree.animate(this.layouts, { bottom: 0 }, { bottom: -145 }, this.obj.config.anim.duration, this.obj.config.anim.func);
      ...
      i.innerHTML = e, Object.assign(i.style, { position: "absolute", "background-color": t, color: "#ffffff", padding: "15px", "border-radius": "40px", opacity: 0, overflow: "hidden", "white-space": "nowrap", "text-align": "center" }), this.obj.element.appendChild(i);
      var r = this.obj.width() / 2 - i.offsetWidth / 2, a = this.obj.height() / 2 - i.offsetHeight / 2;
      i.style.left = r + "px", i.style.top = a + "px";
      var n = i.offsetWidth;
      return i.style.width = "20px", FamilyTree.animate(i, { opacity: 0, width: 10 }, { opacity: 1, width: n }, this.obj.config.anim.duration, this.obj.config.anim.func), true;
    }, void 0 === FamilyTree && (FamilyTree = {}), FamilyTree._validateConfig = function(e) {
      return !!e || (console.error("config is not defined"), false);
    }, FamilyTree._arrayContains = function(e, t) {
      if (e && Array.isArray(e)) {
        for (var i = e.length; i--; ) if (e[i] === t) return true;
      }
      return false;
      ...
      n.className = "bft-ripple-container", e.addEventListener("mousedown", function(t2) {
        var i2, r2, a2, n2, o;
        return this, r2 = document.createElement("span"), a2 = this.offsetWidth, i2 = this.getBoundingClientRect(), o = t2.pageX - i2.left - a2 / 2, n2 = "top:" + (t2.pageY - i2.top - a2 / 2) + "px; left: " + o + "px; height: " + a2 + "px; width: " + a2 + "px;", e.rippleContainer.appendChild(r2), r2.setAttribute("style", n2);
        ...
        var e2, t2;
        return t2 = this, e2 = arguments, clearTimeout(a), a = setTimeout(function() {
          return i.apply(t2, e2);
        }, r);
      ...
      if (t.changedTouches.length) {
        ...
        return isNaN(i.x) || isNaN(i.y) ? { x: t.changedTouches[0].pageX, y: t.changedTouches[0].pageY } : { x: t.changedTouches[0].pageX - i.x, y: t.changedTouches[0].pageY - i.y };
      }
      ...
      return Array.from(t.body.childNodes).some((e2) => 1 === e2.nodeType);
      ...
      m || (m = "ellipsis");
      var f = m.split("-");
      if (f.length > 1 && (a = parseInt(m.split("-")[1]), f.length > 2 && "ellipsis" == f[2] && (n = true)), !c) return FamilyTree._escapeHtml(e);
      ...
      if (-1 != m.indexOf("multiline")) {
        ...
        y = 1;
        for (var F = 1, x = false, _ = 1; _ < g.length; _++) {
          ...
          if (T.firstChild.data += " " + g[_], T.getComputedTextLength() > c) {
            if (T.firstChild.data = T.firstChild.data.slice(0, w), F++, a && F > a) {
              if (n && p.children.length == a) {
                ...
                p.children[a - 1].textContent = k.substring(0, k.length - 3) + "...", x = true;
              }
              break;
            }
      ...
      for (var o = 0; o < n; o++) !function() {
        var e2 = o, t2 = a[e2];
        FamilyTree._getDataUri(t2.getAttribute(i), function(a2) {
          a2.success && t2.setAttribute(i, a2.result), e2 == n - 1 && r();
        });
      }();
    }, FamilyTree._getDataUri = function(e, t) {
      if (-1 != e.indexOf("base64")) t({ success: false });
      else {
        var i = new XMLHttpRequest();
        i.open("GET", e), i.responseType = "blob", i.onload = function() {
          200 === i.status ? r.readAsDataURL(i.response) : 404 === i.status && t({ success: false, result: i.status });
        };
        var r = new FileReader();
        r.onloadend = function() {
          t({ success: true, result: r.result });
        }, i.send();
      }
      ...
      for (var t = [], i = function(e2) {
        for (var i2 = "", r2 = 0; r2 < t.length; r2++) {
          var a2;
          (a2 = "reportsTo" == t[r2] ? null : null == e2[t[r2]] ? "" : e2[t[r2]]) instanceof Date && (a2 = a2.toLocaleString());
          var n2 = (a2 = null === a2 ? "" : a2.toString()).replace(/"/g, '""'), o = new RegExp('("|;|\n)', "g");
          n2.search(o) >= 0 && (n2 = '"' + n2 + '"'), r2 > 0 && (i2 += FamilyTree.CSV_DELIMITER), i2 += n2;
        }
        return i2 + "\n";
      ...
      return (e = e.toString().toLowerCase()).replace(/([àáâãäå])|([ç])|([èéêë])|([ìíîï])|([ñ])|([òóôõöø])|([ß])|([ùúûü])|([ÿ])|([æ])/g, function(e2, t, i, r, a, n, o, l, s, d, c) {
      ...
      return e.msie && FamilyTree.scroll.ie ? FamilyTree.scroll.ie : e.edge && FamilyTree.scroll.edge ? FamilyTree.scroll.edge : e.safari && FamilyTree.scroll.safari ? FamilyTree.scroll.safari : e.chrome && FamilyTree.scroll.chrome ? FamilyTree.scroll.chrome : e.firefox && FamilyTree.scroll.firefox ? FamilyTree.scroll.firefox : e.opera && FamilyTree.scroll.opera ? FamilyTree.scroll.opera : { smooth: FamilyTree.scroll.smooth, speed: FamilyTree.scroll.speed };
      ...
      for (var r = 0, a = 0; a < t.childrenIds.length; a++) {
        ...
        n && ((i || true === n.collapsed) && r++, r += FamilyTree.collapsedChildrenTotalCount(e, n, true));
      }
      return r;
      ...
      function a(e2, t2, i2, r2) {
        var a2 = (r2 - 90) * Math.PI / 180;
        return { x: e2 + i2 * Math.cos(a2), y: t2 + i2 * Math.sin(a2) };
      }
      function n(e2, t2, i2, r2, n2) {
        var o = a(e2, t2, i2, n2), l = a(e2, t2, i2, r2), s = n2 - r2 <= 180 ? "0" : "1";
        return ["M", o.x, o.y, "A", i2, i2, 0, s, 0, l.x, l.y].join(" ");
      }
      ...
      "function" == typeof IntersectionObserver ? new IntersectionObserver(function(e2, i) {
        e2.forEach(function(e3) {
          var i2 = e3.intersectionRatio > 0;
          0 == e3.intersectionRatio && (i2 = e3.isIntersecting), t(i2);
        });
      }).observe(e) : t(true);
      ...
      function r(e2, t2, i2) {
        var r2 = t2.x - e2.x, n2 = t2.y - e2.y, o2 = Math.sqrt(r2 * r2 + n2 * n2);
        return a(e2, t2, Math.min(1, i2 / o2));
      }
      function a(e2, t2, i2) {
        return { x: e2.x + (t2.x - e2.x) * i2, y: e2.y + (t2.y - e2.y) * i2 };
      }
      function n(e2, t2) {
        e2.length > 2 && (e2[e2.length - 2] = t2.x, e2[e2.length - 1] = t2.y);
      }
      function o(e2) {
        return { x: parseFloat(e2[e2.length - 2]), y: parseFloat(e2[e2.length - 1]) };
      }
      Array.isArray(e) || (e = (e = e.split(/[,\s]/).reduce(function(e2, t2) {
        var i2 = t2.match("([a-zA-Z])(.+)");
        return i2 ? (e2.push(i2[1]), e2.push(i2[2])) : e2.push(t2), e2;
      }, [])).reduce(function(e2, t2) {
        return parseFloat(t2) == t2 && e2.length ? e2[e2.length - 1].push(t2) : e2.push([t2]), e2;
      }, []));
      var l = [];
      if (e.length > 1) {
        var s = o(e[0]), d = null;
        ...
        for (var c = 1; c < e.length; c++) {
          ...
          if (p && m && m.length > 2 && "L" == h[0] && p.length > 2 && "L" == p[0]) {
            ...
            var T = a(f, g, 0.5), b = a(g, u, 0.5), F = ["C", T.x, T.y, b.x, b.y, u.x, u.y];
      ...
      return l.reduce(function(e2, t2) {
        return e2 + t2.join(" ") + " ";
      }, "");
    ...
    <rect style="opacity: 0" x="2" y="2" width="20" height="20"></rect>    
      ...
      var t;
      "object" == typeof e ? e = (t = e).focusId : t = this.editUI.content(e, true, true, "100%", true);
      ...
      return null == e && (e = {}), "svg" == t ? (e.ext = "svg", e.mime = "image/svg+xml") : "pdf" == t ? (e.mime = "application/pdf", e.ext = "pdf") : "png" == t && (e.mime = "image/png", e.ext = "png"), null == e.margin && (e.margin = [50, 40, 50, 40]), null == e.padding && (e.padding = 0), null == e.landscape && (e.landscape = false), null == e.filename && (e.filename = "FamilyTree." + e.ext), null == e.scale && (e.scale = "fit"), null == e.format && (e.format = "fit"), null == e.header && (e.header = ""), "pdf" == t && null == e.footer ? e.footer = "Page {current-page} of {total-pages}" : null == e.footer && (e.footer = ""), null == e.openInNewTab && (e.openInNewTab = false), null == e.mode && (e.mode = "bft-" + this.config.mode), e;
    }, FamilyTree.prototype._export = function(e, t) {
      var i = this, r = { id: e.nodeId, expandChildren: e.expandChildren, min: e.min };
      e.margin && e.margin[0] < 2 && (e.margin[0] = 2), e.margin && e.margin[1] < 2 && (e.margin[1] = 2), e.margin && e.margin[2] < 2 && (e.margin[2] = 2), e.margin && e.margin[3] < 2 && (e.margin[3] = 2), this._draw(false, FamilyTree.action.exporting, r, function(r2, a) {
        var n = document.createElement("div");
        if (n.innerHTML = r2, e.padding > 0) {
        ...
        if ("svg" == e.ext) if (t) t(e, n.innerHTML);
        else {
          (o = n.querySelector("svg")).classList.add("bft-" + i.config.mode);
          var s = { content: n.innerHTML, options: e, styles: "" }, d = FamilyTree.events.publish("exportstart", [i, s]), c = i.element.querySelector("[data-bft-styles]");
          if (c && (s.styles += c.outerHTML), s.styles && (n.childNodes[0].insertAdjacentHTML("afterbegin", s.styles), s.content = n.innerHTML), false === d) return false;
          if (false === (d = FamilyTree.events.publish("exportend", [i, s]))) return false;
          FamilyTree._downloadFile(e.mime, s.content, s.options.filename, s.options.openInNewTab, s.options.ext);
        }
        else i._pages(e, n.querySelector("svg"), a, function(r3) {
          var a2 = { content: n.innerHTML, options: e, pages: r3, styles: "" }, o2 = FamilyTree.events.publish("exportstart", [i, a2]), l2 = i.element.querySelector("[data-bft-styles]");
          if (l2 && (a2.styles += l2.outerHTML), false === o2) return false;
          t || FamilyTree.loading.show(i), t ? t(i, a2, n.querySelector("svg")) : (a2 = JSON.stringify(a2), FamilyTree._ajax(i.config.exportUrl + "/v3", "POST", a2, "arraybuffer", function(t2) {
            var r4 = FamilyTree.events.publish("exportend", [i, t2]);
            if (FamilyTree.loading.hide(i), false === r4) return false;
            FamilyTree._downloadFile(e.mime, t2, e.filename, e.openInNewTab, e.ext);
          }));
        });
      });
      ...
      i ? (r = [], FamilyTree._exportIterateForJSON_XML_CSV(this, i, t, r)) : false === t.min || false === t.expandChildren ? FamilyTree._exportIterateForJSON_XML_CSV(this, this.roots, t, r) : r = JSON.parse(JSON.stringify(this.config.nodes));
      var a = { ext: "csv", filename: e, options: t, nodes: r };
      if (false === FamilyTree.events.publish("exportstart", [this, a])) return false;
      var n = FamilyTree._json2csv(a.nodes), o = { ext: a.ext, filename: a.filename, options: t, nodes: a.nodes, content: n };
      if (false === FamilyTree.events.publish("exportend", [this, o])) return false;
      ...
      if (false === FamilyTree.events.publish("exportstart", [this, a])) return false;
      var n = FamilyTree._json2xml(a.nodes), o = { ext: a.ext, filename: a.filename, options: t, nodes: a.nodes, content: n };
      if (false === FamilyTree.events.publish("exportend", [this, o])) return false;
      ...
      if (false === FamilyTree.events.publish("exportend", [this, n])) return false;
      ...
      var l = a[0], s = a[1], d = a[2], c = a[3], m = { w: e.landscape ? o - (e.margin[1] + e.margin[3]) : n - (e.margin[1] + e.margin[3]), h: e.landscape ? n - (e.margin[0] + e.margin[2]) : o - (e.margin[0] + e.margin[2]) }, h = { w: e.landscape ? o : n, h: e.landscape ? n : o };
      t.setAttribute("width", m.w), t.setAttribute("height", m.h);
      var p = m.w * (100 / i), f = m.h * (100 / i), u = l, y = s, g = [], v = true;
      ...
      return FamilyTree.isNEU(e) || null == e.id || null != e.nodeId || (e.nodeId = e.id), (FamilyTree.isNEU(e) || FamilyTree.isNEU(e.nodeId)) && console.error("options.nodeId is not defilned"), "svg" == t ? (e.ext = "svg", e.mime = "image/svg+xml") : "pdf" == t ? (e.mime = "application/pdf", e.ext = "pdf") : "png" == t && (e.mime = "image/png", e.ext = "png"), null == e.margin && (e.margin = [50, 40, 50, 40]), null == e.padding && (e.padding = 0), null == e.landscape && (e.landscape = false), null == e.filename && (e.filename = "Profile." + e.ext), null == e.scale && (e.scale = "fit"), null == e.format && (e.format = "A4"), null == e.header && (e.header = ""), null == e.footer && (e.footer = ""), null == e.openInNewTab && (e.openInNewTab = false), null == e.mode && (e.mode = "bft-" + this.config.mode), e;
    }, FamilyTree._defaultExportProfileOptionsForCSV_SVG_JSON = function(e, t) {
      return FamilyTree.isNEU(e) && (e = {}), "string" == typeof e && (e = { filename: e }), FamilyTree.isNEU(e.filename) && (e.filename = `FamilyTree.${t}`), FamilyTree.isNEU(e.expandChildren) && (e.expandChildren = true), FamilyTree.isNEU(e.min) && (e.min = true), FamilyTree.isNEU(e.openInNewTab) && (e.openInNewTab = false), e;
      ...
      var n = { w: e.landscape ? a - (e.margin[1] + e.margin[3]) : r - (e.margin[1] + e.margin[3]), h: e.landscape ? r - (e.margin[0] + e.margin[2]) : a - (e.margin[0] + e.margin[2]) }, o = { w: e.landscape ? a : r, h: e.landscape ? r : a }, l = this.editUI.content(e.nodeId, true, true, "100%", true).element;
      FamilyTree.input.init(l);
      var s = { content: l.outerHTML, options: e, pages: [{ vb: "", innerSize: n, size: o }], styles: "" };
      if (!t) {
        if (false === FamilyTree.events.publish("exportstart", [i, s])) return false;
      ...
      s = JSON.stringify(s), FamilyTree._ajax(this.config.exportUrl + "/v3", "POST", s, "arraybuffer", function(r2) {
        if (t) t(i, r2);
        else {
          var a2 = FamilyTree.events.publish("exportend", [i, r2]);
          if (FamilyTree.loading.hide(i), false === a2) return false;
          FamilyTree._downloadFile(e.mime, r2, e.filename, e.openInNewTab, e.ext);
        }
      });
    }, void 0 === FamilyTree && (FamilyTree = {}), FamilyTree.events = /* @__PURE__ */ function() {
      var e = {};
      return { on: function(t, i, r) {
        Array.isArray(e[t]) || (e[t] = []), e[t].push({ listener: i, event_id: r });
      }, removeAll: function(t) {
        Array.isArray(e[t]) || (e[t] = []), e[t] = [];
      }, remove: function(t, i, r) {
        var a = false;
        if (e[t] && Array.isArray(e[t]) && e[t].length > 0) for (var n = e[t].length - 1; n >= 0; n--) (!FamilyTree.isNEU(r) && !FamilyTree.isNEU(i) && e[t][n].event_id == r && e[t][n].listener == i || !FamilyTree.isNEU(r) && FamilyTree.isNEU(i) && e[t][n].event_id == r || FamilyTree.isNEU(r) && !FamilyTree.isNEU(i) && e[t][n].listener == i || FamilyTree.isNEU(r) && FamilyTree.isNEU(i)) && (e[t].splice(n, 1), a = true);
        return a;
      }, has: function(t, i) {
        if (e[t] && Array.isArray(e[t]) && e[t].length > 0) {
          if (FamilyTree.isNEU(i)) return true;
          for (var r = 0; r < e[t].length; r++) if (e[t][r].event_id == i) return true;
        }
        return false;
        ...
        if (e[t]) {
          ...
          if (r.length > 0) {
            var o = true;
            for (a = 0; a < r.length && (1 == i.length ? o = r[a](i[0]) && o : 2 == i.length ? o = r[a](i[0], i[1]) && o : 3 == i.length ? o = r[a](i[0], i[1], i[2]) && o : 4 == i.length ? o = r[a](i[0], i[1], i[2], i[3]) && o : 5 == i.length && (o = r[a](i[0], i[1], i[2], i[3], i[4]) && o), false !== o); a++) ;
            return o;
          }
        }
      } };
      ...
      t.setAttribute("type", "file"), t.setAttribute("accept", ".csv"), t.style.display = "none", t.onchange = function(t2) {
        var i = t2.target, r = new FileReader();
        r.onload = function() {
          var t3 = r.result, i2 = FamilyTree._csvToArray(t3), a = [], n = i2[0];
          FamilyTree._importSetColumnNames(n, function(t4) {
            for (var r2 = 1; r2 < i2.length; r2++) {
              for (var n2 = {}, o = 0; o < i2[r2].length; o++) {
                var l = t4[o], s = i2[r2][o];
                n2[l] = FamilyTree._convertStringToArray(l, s);
              }
              "" != n2.id.trim() && a.push(n2);
            }
            var d = { nodes: a, columnNames: i2[0] };
      ...
      if (-1 == e.indexOf("id") || -1 == e.indexOf("pid")) {
        ...
        b.innerHTML = "Import", b.style.fontSize = "16px", b.style.color = "rgb(122, 122, 122)", b.style.padding = "5px 20px", b.style.margin = "20px auto", b.style.display = "block", b.onclick = function() {
          ...
          var i2 = h.options[h.selectedIndex].value, r2 = e.indexOf(i2);
          e[r2] = "id";
          var n2 = v.options[v.selectedIndex].value, o2 = e.indexOf(n2);
          e[o2] = "pid", t(e);
        };
        var F = document.createElement("DIV");
        return F.appendChild(b), i.appendChild(F), l.onclick = function(e2) {
          a._overlay && a._overlay.parentNode.removeChild(a._overlay), a.parentNode.removeChild(a), e2.stopPropagation();
        }, n.onmousedown = function(e2) {
          e2 = e2 || window.event, a._dragging = true, a._originalLeft = a.offsetLeft, a._originalTop = a.offsetTop, a._mouseLeft = e2.clientX, a._mouseTop = e2.clientY;
        }, document.onmousemove = function(e2) {
          e2 = e2 || window.event, a._dragging && (a.style.left = a._originalLeft + e2.clientX - a._mouseLeft + "px", a.style.top = a._originalTop + e2.clientY - a._mouseTop + "px");
        }, document.onmouseup = function(e2) {
          e2 = e2 || window.event, a._dragging && (a.style.left = a._originalLeft + e2.clientX - a._mouseLeft + "px", a.style.top = a._originalTop + e2.clientY - a._mouseTop + "px", a._dragging = false);
        }, a;
      }
      t(e);
      ...
      var e = this, t = document.createElement("INPUT");
      t.setAttribute("type", "file"), t.setAttribute("accept", ".xml"), t.style.display = "none", t.onchange = function(t2) {
        var i = t2.target, r = new FileReader();
        r.onload = function() {
          var t3 = r.result, i2 = FamilyTree._xml2json(t3);
          0 != FamilyTree.events.publish("import", [e, i2]) && (e._putInUndoStack(), e.clearRedo(), e.config.nodes = i2, FamilyTree.events.publish("updated", [e]), e.filterUI.update(), e.draw());
        }, r.readAsText(i.files[0]);
      }, t.click();
    }, FamilyTree.prototype.importJSON = function() {
      var e = this, t = document.createElement("INPUT");
      t.setAttribute("type", "file"), t.setAttribute("accept", ".json"), t.style.display = "none", t.onchange = function(t2) {
        var i = t2.target, r = new FileReader();
        r.onload = function() {
          var t3 = r.result, i2 = JSON.parse(t3);
          0 != FamilyTree.events.publish("import", [e, i2]) && (e._putInUndoStack(), e.clearRedo(), e.config.nodes = i2, FamilyTree.events.publish("updated", [e]), e.filterUI.update(), e.draw());
        }, r.readAsText(i.files[0]);
      }, t.click();
      ...
      var r = { id: e, ids: t };
      this._draw(false, FamilyTree.action.expand, r, i);
    }, FamilyTree.prototype.collapse = function(e, t, i) {
      this._resetMovableNodes();
      var r = { id: e, ids: t };
      this._draw(false, FamilyTree.action.collapse, r, i);
      ...
      this._draw(false, FamilyTree.action.collapse, a, r);
    }, FamilyTree.prototype.changeRoots = function(e, t, i) {
      this.config.roots = t;
      var r = { id: e, changeRoots: t };
      this._draw(false, FamilyTree.action.update, r, i);
    }, FamilyTree.prototype._resetMovableNodes = function() {
      if (FamilyTree.RESET_MOVABLE_ONEXPANDCOLLAPSE && null != this.config.movable) {
        for (var e = false, t = 0; t < this.config.nodes.length; t++) {
          var i = this.config.nodes[t];
          null != i.movex && (i.movex = 0, e = true), null != i.movey && (i.movey = 0, e = true);
        }
        e && FamilyTree.events.publish("updated", [this]);
      }
    }, FamilyTree.prototype.maximize = function(e, t, i, r) {
      var a = this, n = { id: e, options: {} };
      FamilyTree.isNEU(n.id) && (n.id = this.roots[0].id, n.all = true), n.options.horizontal = false, n.options.vertical = false, t && (n.options.horizontal = t), i && (n.options.vertical = i), this._draw(false, FamilyTree.action.maximize, n, function() {
        a.ripple(e), r && r();
      });
    }, FamilyTree.prototype.minimize = function(e, t) {
      var i = this, r = { id: e };
      FamilyTree.isNEU(r.id) && (r.id = this.roots[0].id, r.all = true), this._draw(false, FamilyTree.action.minimize, r, function() {
        i.ripple(e), t && t();
      });
      ...
      if (i.length) {
        if (false === FamilyTree.events.publish("expcollclick", [this, false, e, i])) return false;
        this.expand(e, i, false);
      } else {
        if (false === FamilyTree.events.publish("expcollclick", [this, true, e, t.childrenIds])) return false;
        this.collapse(e, t.childrenIds, false);
      }
    }, FamilyTree.prototype._upHandler = function(e) {
      this.nodeMenuUI.hide(), this.nodeContextMenuUI.hide(), this.menuUI.hide(), this.nodeCircleMenuUI.hide();
      var t = this._upHandlerCreateArgs(e);
      if (false === FamilyTree.events.publish("up-click", [this, t])) return false;
      this.changeRoots(t.id, t.roots, false);
      ...
      return e;
    }, writable: true, configurable: true, enumerable: false }), Array.prototype.has || Object.defineProperty(Array.prototype, "has", { value: function(e) {
      for (var t = 0; t < this.length; t++) if (this[t] == e) return true;
      return false;
    }, writable: true, configurable: true, enumerable: false }), Array.prototype.compare || Object.defineProperty(Array.prototype, "compare", { value: function(e) {
      if (this.length != e.length) return false;
      for (var t = 0; t < this.length; t++) if (!e.has(this[t])) return false;
      return true;
    }, writable: true, configurable: true, enumerable: false }), Object.assign || Object.defineProperty(Object, "assign", { value: function(e, t) {
      "use strict";
      ...
      return i;
    }, writable: true, configurable: true }), FamilyTree.prototype._globalMouseDownHandler = function(e, t) {
      var i = { move: "mousemove", up: "mouseup", leave: "mouseleave" };
      if (-1 != t.type.indexOf("touch") && (1 == t.touches.length ? this._touch = { x: t.touches[0].clientX, y: t.touches[0].clientY } : this._touch = null, i = { move: "touchmove", up: "touchend", touchstart: "touchstart" }), e == t.target) return t.stopPropagation(), t.preventDefault(), void this._mouseDownHandler(e, t, i);
      ...
      if (-1 != t.type.indexOf("touch") && this._touch && 1 == t.changedTouches.length) {
        if (t.changedTouches.length) {
          var i = { x: t.changedTouches[0].clientX, y: t.changedTouches[0].clientY }, r = FamilyTree.t(this.config.template, false, this.getScale()).size, a = this.getScale(), n = Math.abs(i.x - this._touch.x) / a, o = Math.abs(i.y - this._touch.y) / a;
      ...
      var i = this, r = false, a = this.config.zoom.speed, n = this.config.zoom.smooth, o = 0, l = this.getScale(), s = FamilyTree._centerPointInPercent(e, t.pageX, t.pageY);
      var d = window.requestAnimationFrame || window.webkitRequestAnimationFrame || window.mozRequestAnimationFrame || window.oRequestAnimationFrame || window.msRequestAnimationFrame || function(e2) {
        setTimeout(e2, 20);
      };
      t.preventDefault();
      var c = t.delta || t.wheelDelta;
      void 0 === c && (c = -t.detail), c = Math.max(-1, Math.min(1, c)), o += -c * a, r || function e2() {
        r = true;
        var t2 = (o - l) / n;
        t2 > 0 ? t2++ : t2--, l += t2, i.zoom(1 - t2 / 12 / 50, s), parseInt(l) == parseInt(o) ? r = false : d(e2);
      }();
      ...
      if (n.draggable) {
        ...
        var h = this.getSvg(), p = { x: l.x, y: l.y }, f = e.cloneNode(true);
        h.insertBefore(f, h.firstChild);
        var u = FamilyTree._getTransform(f), y = u[4], g = u[5], v = function(e2) {
          for (; e2 && !e2.hasAttribute(FamilyTree.attr.control_node_circle_menu_wrraper_id); ) e2 = e2.parentNode;
          if (e2) {
            var t2 = FamilyTree._getTransform(e2);
            return { x: t2[4], y: t2[5] };
          }
        ...
        var T = function(e2, t2) {
          if (null != e2) {
            t2.classList.remove("bft-drag-over");
            for (var i2 = FamilyTree.getStParentNodes(o.getNode(c)), r2 = 0; r2 < i2.length; r2++) {
              var a2 = o.getNodeElement(i2[r2].id);
              a2 && (a2.style.opacity = 1);
            }
          }
        }, b = function(t2) {
          if (p) {
            var i2 = FamilyTree._getClientXY(t2), r2 = t2.target;
            FamilyTree.isMobile() && (r2 = document.elementFromPoint(i2.x, i2.y)), i2.x += v.x * d, i2.y += v.y * d;
            var l2 = FamilyTree._getOffsetXY(o.element, t2), s2 = { left: o.width() - (l2.x + o.config.padding) < 0, right: l2.x - o.config.padding < 0, up: o.height() - (l2.y + o.config.padding) < 0, down: l2.y - o.config.padding < 0 };
            if (s2.left || s2.right || s2.up || s2.down) {
              ...
              var b2 = u[4], x = u[5], _ = p.x, w = p.y, k = i2.x, S = i2.y;
              o.moveStart(s2, function(e2) {
                u[4] = b2 + e2.x, u[5] = x + e2.y, p.x = _ - e2.xWithoutScale, p.y = w - e2.yWithoutScale, i2.x = k - e2.xWithoutScale, i2.y = S - e2.yWithoutScale, f.setAttribute("transform", "matrix(" + u.toString() + ")");
              });
            } else {
              for (o.moveEnd(), h.classList && (h.classList.add("bft-cursor-grab"), h.classList.remove("bft-cursor-move"), h.classList.remove("bft-cursor-nodrop"), h.classList.remove("bft-cursor-copy")), T(c, m), c = null, m = null; null != r2 && r2 != h; ) {
                if (r2.hasAttribute && r2.hasAttribute(FamilyTree.attr.node_id)) {
                  var C = r2.getAttribute(FamilyTree.attr.node_id);
                  c = C, m = r2;
                  break;
                }
                r2 = r2.parentNode;
              ...
              var E = (i2.x - p.x) / d, M = (i2.y - p.y) / d;
              if (u[4] = y + E, u[5] = g + M, !e._dragEventFired && (Math.abs(i2.x - p.x) > FamilyTree.FIRE_DRAG_NOT_CLICK_IF_MOVE || Math.abs(i2.y - p.y) > FamilyTree.FIRE_DRAG_NOT_CLICK_IF_MOVE)) false === FamilyTree.events.publish("drag", [o.nodeCircleMenuUI, { from: C, menuItem: n, menuItemName: a }]) && F(), e._dragEventFired = true;
              f.setAttribute("transform", "matrix(" + u.toString() + ")");
            }
          }
        }, F = function(t2) {
          if (o.moveEnd(), h.classList && (h.classList.remove("bft-cursor-grab"), h.classList.remove("bft-cursor-move"), h.classList.remove("bft-cursor-nodrop"), h.classList.remove("bft-cursor-copy")), h.removeEventListener(i.move, b), h.removeEventListener(i.up, F), i.leave && h.removeEventListener(i.leave, F), s.id == c || null == c) return h.removeChild(f), o._gragStartedId = null, void (e._dragEventFired && FamilyTree.events.publish("drop", [o.nodeCircleMenuUI, { from: s.id, menuItemName: a, menuItem: n, event: t2 }]));
          var r2 = o.getNode(c);
          FamilyTree.events.publish("drop", [o.nodeCircleMenuUI, { from: s.id, to: r2.id, menuItem: n, menuItemName: a, event: t2 }]), T(c, m), h.removeChild(f), o._gragStartedId = null;
        };
      ...
      var r = this, a = e.getAttribute(FamilyTree.attr.node_id), n = [], o = function(e2, t2) {
        if (Array.isArray(e2)) for (var i2 = 0; i2 < e2.length; i2++) o(e2[i2], t2);
        else {
          t2.push(e2.id);
          for (i2 = 0; i2 < e2.stChildren.length; i2++) o(e2.stChildren[i2], t2);
          for (i2 = 0; i2 < e2.children.length; i2++) o(e2.children[i2], t2);
        }
      }, l = function(e2, t2) {
        if (Array.isArray(e2)) for (var i2 = 0; i2 < e2.length; i2++) o(e2[i2], t2);
        else {
          t2.push(e2.id);
          for (i2 = 0; i2 < e2.stChildrenIds.length; i2++) l(r.getNode(e2.stChildrenIds[i2]), t2);
          for (i2 = 0; i2 < e2.childrenIds.length; i2++) l(r.getNode(e2.childrenIds[i2]), t2);
        }
      }, s = this.getNode(a);
      o(s, n);
      ...
      var C = { x: c.x, y: c.y }, I = r.getScale(), N = function(e2, t2) {
        if (null != e2) {
          t2.classList.remove("bft-drag-over");
          for (var i2 = r.getNode(k), a2 = FamilyTree.getStParentNodes(i2), n2 = 0; n2 < a2.length; n2++) {
            var o2 = r.getNodeElement(a2[n2].id);
            o2 && (o2.style.opacity = 1);
          }
        }
      }, A = function(t2) {
        if (C) {
          var i2 = FamilyTree._getClientXY(t2), o2 = t2.target;
          FamilyTree.isMobile() && (o2 = document.elementFromPoint(i2.x, i2.y));
          var l2 = FamilyTree._getOffsetXY(r.element, t2), c2 = { left: r.width() - (l2.x + r.config.padding) < 0, right: l2.x - r.config.padding < 0, up: r.height() - (l2.y + r.config.padding) < 0, down: l2.y - r.config.padding < 0 };
          if (c2.left || c2.right || c2.up || c2.down) {
            ...
            for (var T2 = [], b2 = [], F2 = [], x2 = [], _2 = 0; _2 < h.length; _2++) T2.push(h[_2][4]), b2.push(h[_2][5]), g[_2] ? (F2.push(g[_2][4]), x2.push(g[_2][5])) : (F2.push(null), x2.push(null));
            var w2 = C.x, A2 = C.y, E = i2.x, M = i2.y;
            r.moveStart(c2, function(e2) {
              for (var t3 = 0; t3 < h.length; t3++) {
                var a2 = T2[t3], n2 = b2[t3], o3 = F2[t3], l3 = x2[t3];
                h[t3][4] = a2 + e2.x, h[t3][5] = n2 + e2.y, C.x = w2 - e2.xWithoutScale, C.y = A2 - e2.yWithoutScale, i2.x = E - e2.xWithoutScale, i2.y = M - e2.yWithoutScale, m[t3].x = a2 + e2.x, m[t3].y = n2 + e2.y, m[t3].movex = e2.x, m[t3].movey = e2.y, g[t3] && (g[t3][4] = o3 + e2.x, g[t3][5] = l3 + e2.y);
                for (var s2 = FamilyTree.ui.link(m[t3], r, I, r.response.bordersByRootIdAndLevel, r.nodes, FamilyTree.action.update, true), d2 = 0; d2 < s2.length; d2++) {
                  var c3 = s2[d2];
                  (p2 = r.element.querySelector(`[data-l-id="[${c3.id}][${c3.childId}]"]`)) && (p2.innerHTML = c3.html);
                }
                if (m[t3].parent) for (s2 = FamilyTree.ui.link(m[t3].parent, r, I, r.response.bordersByRootIdAndLevel, r.nodes, FamilyTree.action.update, true), d2 = 0; d2 < s2.length; d2++) {
                  var p2;
                  c3 = s2[d2];
                  (p2 = r.element.querySelector(`[data-l-id="[${c3.id}][${c3.childId}]"]`)) && (p2.innerHTML = c3.html);
                }
                u[t3].setAttribute("transform", "matrix(" + h[t3].toString() + ")"), y[t3] && y[t3].setAttribute("transform", "matrix(" + g[t3].toString() + ")");
              }
            });
          } else {
            if (r.moveEnd(), d.classList && (d.classList.add("bft-cursor-grab"), d.classList.remove("bft-cursor-move"), d.classList.remove("bft-cursor-nodrop"), d.classList.remove("bft-cursor-copy")), N(k, S), k = null, S = null, r.config.enableDragDrop) for (; null != o2 && o2 != d; ) {
              if (o2.hasAttribute && o2.hasAttribute(FamilyTree.attr.node_id)) {
                var O = o2.getAttribute(FamilyTree.attr.node_id);
            ...
            var D = (i2.x - C.x) / I, H = (i2.y - C.y) / I;
            for (_2 = 0; _2 < h.length; _2++) {
              h[_2][4] = f[_2].x + D, h[_2][5] = f[_2].y + H, g[_2] && (g[_2][4] = v[_2].x + D, g[_2][5] = v[_2].y + H), m[_2].x = p[_2].x + D, m[_2].y = p[_2].y + H, m[_2].movex = D, m[_2].movey = H;
              var z = FamilyTree.ui.link(m[_2], r, I, r.response.bordersByRootIdAndLevel, r.nodes, FamilyTree.action.update, true);
              for (R = 0; R < z.length; R++) {
                var $ = z[R];
                (j = r.element.querySelector(`[data-l-id="[${$.id}][${$.childId}]"]`)) && (j.innerHTML = $.html);
              }
            }
            if (s.parent) if (r.config.movable == FamilyTree.movable.detachTree) (j = r.element.querySelector(`[data-l-id="[${s.parent.id}][${s.id}]"]`)) && j.parentElement.removeChild(j);
            else for (z = FamilyTree.ui.link(s.parent, r, I, r.response.bordersByRootIdAndLevel, r.nodes, FamilyTree.action.update, true), R = 0; R < z.length; R++) {
              var j;
              $ = z[R];
              (j = r.element.querySelector(`[data-l-id="[${$.id}][${$.childId}]"]`)) && (j.innerHTML = $.html);
            }
            if (!e._dragEventFired && (Math.abs(i2.x - C.x) > FamilyTree.FIRE_DRAG_NOT_CLICK_IF_MOVE || Math.abs(i2.y - C.y) > FamilyTree.FIRE_DRAG_NOT_CLICK_IF_MOVE)) {
              if (false === FamilyTree.events.publish("drag", [r, a, t2, n]) && L(), r.config.enableDragDrop) for (_2 = 0; _2 < u.length; _2++) d.insertBefore(u[_2], d.firstChild);
              e._dragEventFired = true;
            }
            for (_2 = 0; _2 < h.length; _2++) u[_2].setAttribute("transform", "matrix(" + h[_2].toString() + ")"), y[_2] && y[_2].setAttribute("transform", "matrix(" + g[_2].toString() + ")");
          }
        }
      }, L = function(t2) {
        for (var a2 = 0; a2 < m.length; a2++) m[a2].x = p[a2].x, m[a2].y = p[a2].y;
        if (r.moveEnd(), d.classList && (d.classList.remove("bft-cursor-grab"), d.classList.remove("bft-cursor-move"), d.classList.remove("bft-cursor-nodrop"), d.classList.remove("bft-cursor-copy")), d.removeEventListener(i.move, A), d.removeEventListener(i.up, L), i.leave && d.removeEventListener(i.leave, L), m[0].id != k && null != k) {
          var n2 = r.getNode(k);
          if (false === (o2 = FamilyTree.events.publish("drop", [r, m[0].id, n2.id, u[0], t2]))) return N(k, S), void (r._gragStartedId = null);
          if (r.canUpdateLink(m[0].id, k)) (g2 = r.get(m[0].id)).pid = k, g2.stpid = null, r.updateNode(g2, null, true);
          else N(k, S);
          r._gragStartedId = null;
        } else {
          if (e._dragEventFired) {
            var o2 = FamilyTree.events.publish("drop", [r, m[0].id, void 0, u[0], t2]);
            if (r.config.movable && false !== o2) if (r.config.movable == FamilyTree.movable.detachTree) {
              var c2 = FamilyTree._getTransform(r.getNodeElement(s.id));
              (g2 = r.get(s.id)).pid = null, g2.stpid = null, r.updateNode(g2, null, true);
            } else {
              var h2 = [];
              r.config.movable == FamilyTree.movable.node ? h2.push(s.id) : l(s, h2);
              var f2 = (c2 = FamilyTree._getTransform(r.getNodeElement(s.id)))[4] - s.x, y2 = c2[5] - s.y;
              for (a2 = 0; a2 < h2.length; a2++) {
                var g2;
                (g2 = r.get(h2[a2])) && (null != g2.movex ? g2.movex += f2 : g2.movex = f2, null != g2.movey ? g2.movey += y2 : g2.movey = y2, r.update(g2));
              }
              FamilyTree.events.publish("updated", [r]), r.draw(FamilyTree.action.update, { dragNodeIdList: h2 });
            }
          }
          r._gragStartedId = null;
        }
      ...
      var s = this, d = this.getSvg(), c = { x: r.x, y: r.y }, m = FamilyTree._getTransform(e), h = m[4], p = m[5], f = s.getScale(), u = e.cloneNode(true);
      u.setAttribute("data-n-id", "draging"), d.insertBefore(u, d.firstChild), u.style.opacity = 0.7;
      var y = function(e2, t2) {
        if (null != e2) {
          t2.classList.remove("bft-drag-over");
          for (var i2 = s.getNode(o), r2 = FamilyTree.getStParentNodes(i2), a2 = 0; a2 < r2.length; a2++) {
            var n2 = s.getNodeElement(r2[a2].id);
        ...
        if (c) {
          var i2 = FamilyTree._getClientXY(t2), r2 = t2.target;
          FamilyTree.isMobile() && (r2 = document.elementFromPoint(i2.x, i2.y));
          var a2 = FamilyTree._getOffsetXY(s.element, t2), g2 = { left: s.width() - (a2.x + s.config.padding) < 0, right: a2.x - s.config.padding < 0, up: s.height() - (a2.y + s.config.padding) < 0, down: a2.y - s.config.padding < 0 };
          if (g2.left || g2.right || g2.up || g2.down) {
            d.classList && (d.classList.remove("bft-cursor-grab"), d.classList.add("bft-cursor-move"), d.classList.remove("bft-cursor-nodrop"), d.classList.remove("bft-cursor-copy"));
            var T = m[4], b = m[5], F = c.x, x = c.y, _ = i2.x, w = i2.y;
            s.moveStart(g2, function(e2) {
              m[4] = T + e2.x, m[5] = b + e2.y, c.x = F - e2.xWithoutScale, c.y = x - e2.yWithoutScale, i2.x = _ - e2.xWithoutScale, i2.y = w - e2.yWithoutScale, u.setAttribute("transform", "matrix(" + m.toString() + ")");
            });
          } else {
            if (s.moveEnd(), d.classList && (d.classList.add("bft-cursor-grab"), d.classList.remove("bft-cursor-move"), d.classList.remove("bft-cursor-nodrop"), d.classList.remove("bft-cursor-copy")), y(o, l), o = null, l = null, s.config.enableDragDrop) for (; null != r2 && r2 != d; ) {
              if (r2.hasAttribute && r2.hasAttribute(FamilyTree.attr.node_id)) {
                var k = r2.getAttribute(FamilyTree.attr.node_id);
            ...
            var A = (i2.x - c.x) / f, L = (i2.y - c.y) / f;
            if (m[4] = h + A, m[5] = p + L, !e._dragEventFired && (Math.abs(i2.x - c.x) > FamilyTree.FIRE_DRAG_NOT_CLICK_IF_MOVE || Math.abs(i2.y - c.y) > FamilyTree.FIRE_DRAG_NOT_CLICK_IF_MOVE)) false === FamilyTree.events.publish("drag", [s, k, t2]) && v(), e._dragEventFired = true;
            u.setAttribute("transform", "matrix(" + m.toString() + ")");
          }
        }
      }, v = function(t2) {
        if (s.moveEnd(), d.classList && (d.classList.remove("bft-cursor-grab"), d.classList.remove("bft-cursor-move"), d.classList.remove("bft-cursor-nodrop"), d.classList.remove("bft-cursor-copy")), d.removeEventListener(i.move, g), d.removeEventListener(i.up, v), i.leave && d.removeEventListener(i.leave, v), n.id == o || null == o) return e._dragEventFired && FamilyTree.events.publish("drop", [s, n.id, void 0, u, t2]), d.removeChild(u), void (s._gragStartedId = null);
        var r2 = s.getNode(o);
        if (false === FamilyTree.events.publish("drop", [s, n.id, r2.id, u, t2])) return y(o, l), d.removeChild(u), void (s._gragStartedId = null);
        if (s.canUpdateLink(n.id, o)) {
          var a2 = s.get(n.id);
          a2.pid = o, a2.stpid = null, null != a2.movex && (a2.movex = void 0), null != a2.movey && (a2.movey = void 0), s.updateNode(a2, null, true);
      ...
      if (this.isVisible) {
        ...
        r.setAttribute("width", this.width()), r.setAttribute("height", this.height()), i[2] = this.width() / s, i[3] = this.height() / s, this.setViewBox(i), this.xScrollUI.create(this.width()), this.yScrollUI.create(this.height()), this._draw(false, FamilyTree.action.resize);
      }
    }, FamilyTree.prototype._nodeDbClickHandler = function(e, t) {
      if (false === FamilyTree.events.publish("dbclick", [this, this.get(e)])) return false;
      ...
      if (i && i._dragEventFired) i._dragEventFired = false;
      else {
        if (false === FamilyTree.events.publish("click", [this, { node: this.getNode(e), event: t }])) return false;
      ...
      i == FamilyTree.action.details && ((r = this.getNode(e)) && (this.editUI.show(r.id, true), this.ripple(r.id, t.clientX, t.clientY)));
      ...
      false !== this.addNode(e, null, true) && this.center(e.id);
    }, FamilyTree.prototype.toggleExpandCollapse = function(e, t) {
      var i = this.getNode(e), r = this.getCollapsedIds(i);
      if (r.length) {
        if (false === FamilyTree.events.publish("expcollclick", [this, false, e, r])) return false;
        this.expand(e, r, false);
      } else {
        if (false === FamilyTree.events.publish("expcollclick", [this, true, e, i.childrenIds])) return false;
        this.collapse(e, i.childrenIds, false);
      }
      ...
      var a = this.getViewBox(), n = this.getScale(), o = FamilyTree._getClientTouchesXY(t, 0), l = FamilyTree._getClientTouchesXY(t, 1), s = { diffX: 0, diffY: 0, x0: o.x, y0: o.y, type: "pan", viewBoxLeft: a[0], viewBoxTop: a[1] };
      ...
      var d = function(e2) {
        var t2 = FamilyTree._getClientTouchesXY(e2, 0);
        if (s && "pan" == s.type) {
          r._hideBeforeAnimation(), s.diffX = t2.x - s.x0, s.diffY = t2.y - s.y0;
          var i2 = -s.diffY / n + s.viewBoxTop, o2 = -s.diffX / n + s.viewBoxLeft;
          r._move(i2, o2, a);
        } else if (s && "pinch" == s.type) {
          var l2 = FamilyTree._getClientTouchesXY(e2, 1), d2 = Math.sqrt((t2.x - l2.x) * (t2.x - l2.x) + (t2.y - l2.y) * (t2.y - l2.y)), c2 = 1 + (d2 - s.dist) / (s.dist / 100) / 100;
          s.dist = d2;
          var m = FamilyTree._pinchMiddlePointInPercent(r.element, r.width(), r.height(), e2);
          r.zoom(c2, m);
        }
      }, c = function() {
        "pan" == s.type && r.config.sticky ? setTimeout(function() {
          FamilyTree._moveToBoundaryArea(e, r.getViewBox(), r.response.boundary, function() {
            r._draw(true, FamilyTree.action.pan);
          });
      ...
      r.style.display = "inherit", r.setAttribute("transform", "matrix(0,0,0,0," + n + "," + o + ")"), FamilyTree.animate(r, { transform: [0, 0, 0, 0, n, o], opacity: 0 }, { transform: [1 / t, 0, 0, 1 / t, n, o], opacity: 1 }, 300, FamilyTree.anim.outBack);
    }, FamilyTree.prototype._changeCursorOnPanEnd = function() {
      this.getPointerElement().style.display = "none";
    }, FamilyTree.searchUI = function() {
      this.lastSearch = [], this._searchAfterEnterPress = false, this._event_id = FamilyTree._guid(), this.instance = null;
      ...
      this.instance.element.insertBefore(l, d), FamilyTree.input.init(l), this.input = document.getElementById(s.id), this.xBtn.addEventListener("click", function(e2) {
        e2.preventDefault(), t.hide();
      }), this.input.addEventListener("keypress", function(e2) {
        "Enter" == e2.key && e2.preventDefault();
      }), this.input.addEventListener("focus", function(e2) {
      ...
      }), this.input.addEventListener("keydown", function(e2) {
        ("ArrowDown" == e2.key || "ArrowUp" == e2.key) && e2.preventDefault();
      }), this.input.addEventListener("keyup", function(e2) {
        "ArrowDown" == e2.key ? c() : "ArrowUp" == e2.key ? m() : "Enter" == e2.key ? t._enterHandler() : "Escape" == e2.key ? t.hide() : this.value.length >= FamilyTree.MINIMUM_SYMBOLS_IN_SEARCH_INPUT && t._search();
      });
      var c = function() {
        var e2 = t.instance.element.querySelectorAll("[data-search-item-id]"), i2 = t.instance.element.querySelector('[data-selected="yes"]');
        null == i2 && e2.length > 0 ? e2[0].setAttribute("data-selected", "yes") : e2.length > 0 && i2.nextSibling && i2.nextSibling.setAttribute && (i2.removeAttribute("data-selected"), i2.nextSibling.setAttribute("data-selected", "yes"));
      }, m = function() {
        var e2 = t.instance.element.querySelectorAll("[data-search-item-id]"), i2 = t.instance.element.querySelector('[data-selected="yes"]');
        null == i2 && e2.length > 0 ? e2[e2.length - 1].setAttribute("data-selected", "yes") : e2.length > 0 && i2.previousSibling && i2.previousSibling.setAttribute && (i2.removeAttribute("data-selected"), i2.previousSibling.setAttribute("data-selected", "yes"));
      };
      ...
      if (e) {
        if (e.hasAttribute("data-search-item-id")) {
          ...
          if (this.input.value != FamilyTree.SEARCH_HELP_SYMBOL) {
            var i = FamilyTree.events.publish("", [this.instance, t]), r = FamilyTree.events.publish("searchclick", [this, { nodeId: t }]);
            false === i && (r = false), 0 != r && this.instance.center(t);
          } else this.input.value = t + " ", this.searchTableWrapper.innerHTML = "";
        }
      } else this._searchAfterEnterPress = true, this.__search(), this.searchTableWrapper.innerHTML = "", this.instance.draw();
      ...
      if (this._searchAfterEnterPress) {
        for (var t = 0; t < this.lastSearch.length; t++) if (this.lastSearch[t].id == e) return true;
        return false;
      }
      return null;
      ...
      var e, t = this;
      if (this._searchAfterEnterPress = false, this.input.value == FamilyTree.SEARCH_HELP_SYMBOL) e = this.helpView();
      else {
        this.__search();
        ...
        e = `<table border="0" cellspacing="0" cellpadding="0">
                        <tbody>
                            ${function() {
          for (var e2 = "", r2 = 0; r2 < t.lastSearch.length && !(r2 >= FamilyTree.SEARCH_RESULT_LIMIT); r2++) {
            var a2 = t.lastSearch[r2], n = "";
            if (i) {
              var o = t.instance._get(a2.id);
              "function" == typeof i ? n = i(t.instance, t.instance.getNode(a2.id), o) : o[i] && (n = o[i]);
            }
            var l = "", s = "";
            t.instance.config.searchDisplayField == a2.__searchField ? l = a2.__searchMarks : t.instance.config.searchDisplayField ? (l = a2[t.instance.config.searchDisplayField], FamilyTree.isNEU(l) && (l = ""), s = a2.__searchMarks) : l = a2.__searchMarks;
            var d = { img: n, nodeId: a2.id, first: l, second: s, searchItem: a2, html: FamilyTree.searchUI.createItem(n, a2.id, l, s) };
            FamilyTree.events.publish("add-item", [t, d]), e2 += d.html;
          }
          return e2;
        }()}  
                        </tbody>
      ...
      for (var r = this.instance.element.querySelectorAll("[data-search-item-id]"), a = 0; a < r.length; a++) r[a].addEventListener("click", function() {
        if (this.hasAttribute("data-search-item-id")) {
          var e2 = this.getAttribute("data-search-item-id");
          if (t.input.value != FamilyTree.SEARCH_HELP_SYMBOL) {
            var i2 = FamilyTree.events.publish("searchclick", [t.instance, e2]), r2 = FamilyTree.events.publish("searchclick", [t, { nodeId: e2 }]);
            if (false === i2 && (r2 = false), false !== r2) {
              t.instance.center(this.getAttribute("data-search-item-id"));
              var a2 = t.instance.element.querySelector('[data-selected="yes"]');
              a2 && a2.removeAttribute("data-selected"), this.setAttribute("data-selected", "yes"), t.input.focus();
            }
          } else t.input.value = e2 + " ", t.searchTableWrapper.innerHTML = "", t.input.focus();
        }
      });
      ...
      if (false === FamilyTree.events.publish("hide", [this])) return false;
      this._searchAfterEnterPress && (this._searchAfterEnterPress = false, this.instance.draw()), this.lastSearch = [], this.xBtn && (this.xBtn.style.display = "none"), this.searchTableWrapper && (this.searchTableWrapper.innerHTML = ""), this.input && (this.input.value = "", document.activeElement == this.input && this.input.blur(), document.activeElement == this.xBtn && FamilyTree.input.blurHandler(this.input));
    }, FamilyTree.searchUI.prototype.on = function(e, t) {
      return FamilyTree.events.on(e, t, this._event_id), this;
    }, void 0 === FamilyTree && (FamilyTree = {}), FamilyTree.manager = function(e) {
      this.config = e.config, this.layoutConfigs = e._layoutConfigs, this.visibleNodeIds = [], this.viewBox = null, this.action = null, this.actionParams = null, this.nodes = {}, this.oldNodes = {}, this.maxX = null, this.maxY = null, this.minX = null, this.minY = null, this.bordersByRootIdAndLevel = null, this.roots = null, this.state = null, this.vbIsInitializedFromState = false, this.rootList = [], this.instance = e, this._fixAdjustForExport = { x: 0, y: 0 };
    }, FamilyTree.manager.prototype.read = function(e, t, i, r, a, n, o, l) {
      var s = this;
      FamilyTree.state._get(this.config.state, t, i, function(d) {
        s.state = d, s.action = a, s.actionParams = n, a != FamilyTree.action.init || !s.state || n && n.method && "fit" == n.method ? (s.viewBox = r, s.vbIsInitializedFromState = false) : (s.viewBox = s.state.vb, s.vbIsInitializedFromState = true, Array.isArray(s.state.roots) && (s.config.roots = s.state.roots));
        ...
        if (e) {
          ...
          a != FamilyTree.action.exporting && (s.maxX = c, s.maxY = m, s.minX = h, s.minY = p, s.roots = u, s.nodes = y, s.visibleNodeIds = g.visibleNodeIds), g.bordersByRootIdAndLevel = f, g.roots = u, g.adjustify = { x: 0, y: 0 }, s.state && (g.adjustify = s.state.adjustify), o(g);
        } else s.oldNodes = y || null, s._read(function(e2) {
          c = e2.maxX, m = e2.maxY, h = e2.minX, p = e2.minY, f = e2.bordersByRootIdAndLevel, u = e2.roots, y = e2.nodes;
          var r2 = FamilyTree.manager._getResponse(t, i, s.visibleNodeIds, s.config, c, m, h, p, s.viewBox, u, s.action, s.actionParams, y, s.oldNodes, s.vbIsInitializedFromState);
          r2.notif = e2.limit, r2.roots = u, r2.bordersByRootIdAndLevel = f, r2.adjustify = e2.adjustify, a != FamilyTree.action.exporting && (s.maxX = c, s.maxY = m, s.minX = h, s.minY = p, s.roots = u, s.nodes = y, s.visibleNodeIds = r2.visibleNodeIds, s.bordersByRootIdAndLevel = f, s.rootList = e2.rootList), o(r2);
        }, l);
      });
      ...
      null == o && (o = FamilyTree.local), o._setPositions(n, i.layoutConfigs, function(t2) {
        var o2 = FamilyTree.manager._doNotChangePositionOfClickedNodeIfAny(n, a, i.action, i.actionParams, i.oldNodes, i.config.orientation);
        i.state && i.action == FamilyTree.action.init && (o2 = i.state.adjustify), i.action == FamilyTree.action.exporting ? o2 = i._fixAdjustForExport : i._fixAdjustForExport = o2;
        for (var l = { minX: null, minY: null, maxX: null, maxY: null }, s = {}, d = [], c = 0; c < n.length; c++) FamilyTree.manager._setMinMaxXYAdjustifyIterate(n[c], n[c], l, 0, s, o2, i.config.orientation, d);
        for (var m in d) for (var h in d[m]) {
          var p = s[m][h], f = d[m][h];
          null == p.minX && null == p.minY && null == p.maxX && null == p.maxY && FamilyTree._setMinMaxXY(f, p);
        }
        e({ minX: l.minX, minY: l.minY, maxX: l.maxX, maxY: l.maxY, bordersByRootIdAndLevel: s, nodes: a, roots: n, rootList: r.rootList, limit: t2, adjustify: o2 });
      }, a);
    }, void 0 === FamilyTree && (FamilyTree = {}), FamilyTree.manager._initDinamicNode = function(e, t, i) {
      t && (e.lcn = t), i && (e.isAssistant = true);
      ...
      null == e.collapsed && t.collapse && t.collapse.allChildren ? e.collapsed = true : null == e.collapsed && (e.collapsed = false), a == FamilyTree.action.expand && -1 != i.ids.indexOf(e.id) && (e.collapsed = false), a == FamilyTree.action.collapse && (i.expandIds || i.collapseIds) ? i.expandIds && -1 != i.expandIds.indexOf(e.id) ? e.collapsed = false : i.collapseIds && -1 != i.collapseIds.indexOf(e.id) && (e.collapsed = true) : a == FamilyTree.action.collapse && -1 != i.ids.indexOf(e.id) && (e.collapsed = true), a == FamilyTree.action.expand && "all" == i.ids && (e.collapsed = false), a == FamilyTree.action.exporting && i.expandChildren && (e.collapsed = false), a == FamilyTree.action.init && null != o ? e.collapsed = !o.exp.has(e.id) : a == FamilyTree.action.init ? -1 != e.tags.indexOf("left-partner") || -1 != e.tags.indexOf("right-partner") || -1 != e.tags.indexOf("partner") || e.parentPartner ? e.collapsed = t.collapse && n >= t.collapse.level && -1 == r.indexOf(e.id) : e.collapsed = t.collapse && n >= t.collapse.level - 1 && -1 == r.indexOf(e.id) : a == FamilyTree.action.centerNode || a == FamilyTree.action.insert || a == FamilyTree.action.expand || a == FamilyTree.action.collapse ? r.has(e.id) && (e.collapsed = false) : a == FamilyTree.action.update && i && i.changeRoots && i.changeRoots.has(e.id) && (e.collapsed = false);
      ...
      if (d != FamilyTree.action.minimize || e.min ? d == FamilyTree.action.maximize && true === e.min ? (c.all || c.id == e.id) && (e.min = false) : d == FamilyTree.action.exporting && false === c.min ? e.min = false : d == FamilyTree.action.init && null != m && (e.min = m.min.has(e.id)) : (c.all || c.id == e.id) && (e.min = true), !e.min) for (p = 0; p < e.stChildrenIds.length; p++) {
      ...
      y > 0 && (e.subLevels = y), -1 != e.tags.indexOf("assistant") && null != e.parent && (e.isAssistant = true);
      ...
      for (var s = [], d = FamilyTree._addDottedLines(i), c = 0; c < d.length; c++) {
        ...
        true === p ? m.unshift("match") : false === p && m.unshift("no-match");
      ...
      null != i.orderBy && s.sort(function(t2, r2) {
        var a2 = e[t2].order, n2 = e[r2].order;
        return "number" == typeof a2 || "number" == typeof n2 ? (null == a2 && (a2 = -1), null == n2 && (n2 = -1), i.orderBy.desc ? n2 - a2 : a2 - n2) : "string" == typeof a2 || "string" == typeof n2 ? (null == a2 && (a2 = ""), null == n2 && (n2 = ""), i.orderBy.desc ? n2.localeCompare(a2) : a2.localeCompare(n2)) : void 0;
      });
      ...
      if (FamilyTree.manager.__createNodes(l, s, t, r, a, n, d, e), null != t.roots) {
        ...
        for (var c = 0; c < t.roots.length; c++) {
          ...
          if (m) {
            for (var f = false, u = 0; u < s.length; u++) if (s[u].id == m.id) {
              f = true;
              break;
            }
            if (!f) {
      ...
      if (r == FamilyTree.action.init && t.expand && t.expand.nodes && null == o) for (c = 0; c < t.expand.nodes.length; c++) {
        ...
        for (true === t.expand.allChildren && FamilyTree.manager._addExpandedNodeIdsIterate(g, l, y); g; ) y.push(g.id), null == g.pid && null != g.stpid ? (g = l[g.stpid]).min = false : g = l[g.pid];
      }
        ...
        for (c = 0; c < re.length; c++) for (var v = l[(g = l[re[c]]).pid]; v; ) y.push(v.id), null == v.pid && null != v.stpid ? (v = l[v.stpid]).min = false : v = l[v.pid];
        ...
        for (var T = l[a.id]; T; ) {
          if (y.push(T.id), a.options.parentState === FamilyTree.COLLAPSE_PARENT_NEIGHBORS && T) for (c = 0; c < T.childrenIds.length; c++) {
            (D = l[T.childrenIds[c]]).collapsed = true;
          }
          null == T.pid && null != T.stpid ? (T = l[T.stpid]).min = false : T = l[T.pid];
        }
        T = l[a.id];
        if (a.options.childrenState === FamilyTree.COLLAPSE_SUB_CHILDRENS) for (c = 0; c < T.childrenIds.length; c++) {
          (F = l[T.childrenIds[c]]).collapsed = false;
          for (var b = 0; b < F.childrenIds.length; b++) {
            l[F.childrenIds[b]].collapsed = true;
          }
        }
      ...
      } else if (r == FamilyTree.action.insert) for (g = l[a.insertedNodeId]; g; ) y.push(g.id), null == g.pid && null != g.stpid ? (g = l[g.stpid]).min = false : g = l[g.pid];
      var x = [], _ = {}, w = [], k = {}, S = [];
      ...
      if (r == FamilyTree.action.collapse && a && Array.isArray(a.expandIds) && Array.isArray(a.collapseIds)) for (c = 0; c < a.ids.length; c++) {
        ...
        else (g = l[a.collapseIds[c]]) && (g.collapsed = true);
      }
      ...
      for (c = 0; c < S.length; c++) {
        ...
        for (b = 0; b < P.length; b++) {
          (D = l[P[b]]).collapsed || (D.parentPartner = D.parent, D.parent = g, D.isChildOfPartner = true, g.children.push(D));
        }
        ...
        for (b = 0; b < B.length; b++) {
          (D = l[B[b]]).collapsed || (D.parentPartner = D.parent, D.parent = g, D.isChildOfPartner = true, g.children.push(D));
        }
      ...
      for (var $ in _) {
        (v = l[$]).hasAssistants = true;
        z = new FamilyTree.node(v.id + "_split_assitant_0", v.id, ["assistant"], "split");
        FamilyTree.manager._initDinamicNode(z, v.lcn, true), l[z.id] = z;
        var j = [];
        ...
        if (j.length % 2) {
          ...
          FamilyTree.manager._initDinamicNode(X, Y.lcn, true), X.isAssistant = true, X.w = Y.w, X.h = Y.h, l[X.id] = X, j.splice(j.length - 1, 0, X.id);
        }
        var q = 1;
        for (b = j.length - 1; b >= 0; b--) if (b % 2 && b != j.length - 1) {
          var V = new FamilyTree.node(v.id + "_split_assitant_" + q, v.pid, [], "split");
          FamilyTree.manager._initDinamicNode(V, v.lcn, true), l[V.id] = V, j.splice(b, 0, V.id), q++;
      ...
      if (null != e.x && null != e.y) {
        if (t.lazyLoading && r !== FamilyTree.action.exporting) {
          let a2 = function(e2, t2) {
            var i2 = e2.x, r2 = e2.y, a3 = e2.w, n2 = e2.h, o = t2[0] - FamilyTree.LAZY_LOADING_FACTOR, l = t2[2] + FamilyTree.LAZY_LOADING_FACTOR + t2[0], s = t2[1] - FamilyTree.LAZY_LOADING_FACTOR, d = t2[3] + FamilyTree.LAZY_LOADING_FACTOR + t2[1], c = i2 + a3 > o && l > i2;
            return c && (c = r2 + n2 > s && d > r2), c;
          };
          var a = a2;
          if (a2(e, i)) return true;
          for (var n = 0; n < e.children.length; n++) if (a2(e.children[n], i)) return true;
          return false;
        }
        return true;
      }
      ...
      if (e) {
        ...
        return function e2(i) {
          i.sl > t.sl && (t = i);
          for (var r = 0; r < i.children.length; r++) e2(i.children[r]);
        }(e), t;
      }
    }, FamilyTree.manager._getResponse = function(e, t, i, r, a, n, o, l, s, d, c, m, h, p, f) {
      var u = d[0], y = [], g = { top: null, left: null, bottom: null, right: null, minX: null, maxX: null, minY: null, maxY: null }, v = [[], [], []], T = a - o + 2 * r.padding, b = n - l + 2 * r.padding, F = FamilyTree.getScale(s, e, t, r.scaleInitial, r.scaleMax, r.scaleMin, T, b);
      ...
      return { animations: v, boundary: g, viewBox: s, visibleNodeIds: y, nodes: h, allFields: FamilyTree.manager.getAllFields(r) };
      ...
      if (FamilyTree.manager._isVisible(e, i, r, a)) {
        ...
        else if (a != FamilyTree.action.update && a != FamilyTree.action.insert || !l) a !== FamilyTree.action.exporting && a !== FamilyTree.action.init && -1 == s.indexOf(e.id) && (d[0].push(e.id), d[1].push({ opacity: 0 }), d[2].push({ opacity: 1 }));
        else {
          var f, u;
      ...
      e.isPartner ? e.sl = r - 1 : e.sl = r, null == a[t.id] && (a[t.id] = {}), null == a[t.id][e.sl] && (a[t.id][e.sl] = { minX: null, minY: null, maxX: null, maxY: null }), e.layout ? (null == l[t.id] && (l[t.id] = {}), null == l[t.id][e.sl] && (l[t.id][e.sl] = e)) : FamilyTree._setMinMaxXY(e, a[t.id][e.sl]), null != e.movex && (e.x += e.movex), null != e.movey && (e.y += e.movey), FamilyTree._setMinMaxXY(e, i), r++;
      ...
      if (i != FamilyTree.action.expand && i != FamilyTree.action.collapse && i != FamilyTree.action.minimize && i != FamilyTree.action.maximize && i != FamilyTree.action.centerNode && i != FamilyTree.action.update && i != FamilyTree.action.insert) return { x: 0, y: 0 };
      ...
      if (e.isAssistant && e.isSplit && e.children.length) {
        ...
        for (i = 0; i < s; i++) {
          ...
          FamilyTree.manager._initDinamicNode(c, e.lcn, true), i > 0 && (d[i - 1].children.push(c), c.parent = d[i - 1]), t[c.id] = c, d.push(c);
        }
        if (d.length) {
      ...
      for (var s = i.nodes, d = [], c = {}, m = {}, h = 0; h < s.length; h++) {
        ...
        true === u ? p.unshift("match") : false === u && p.unshift("no-match"), f.gender && p.push(f.gender);
      ...
      if (null != i.orderBy && c) for (var v in c) c[v].sort(function(t2, r2) {
        var a2 = e[t2].order, n2 = e[r2].order;
        return "number" == typeof a2 || "number" == typeof n2 ? (null == a2 && (a2 = -1), null == n2 && (n2 = -1), i.orderBy.desc ? n2 - a2 : a2 - n2) : "string" == typeof a2 || "string" == typeof n2 ? (null == a2 && (a2 = ""), null == n2 && (n2 = ""), i.orderBy.desc ? n2.localeCompare(a2) : a2.localeCompare(n2)) : void 0;
      });
      ...
      for (h = 0; h < o.length; h++) for (var F = 0; F < o.length; F++) if (F != h) {
        for (var x = o[h], _ = o[F], w = false, k = 0; k < x.length; k++) if (_.has(x[k])) {
          w = true;
          break;
        }
      ...
      return t;
    }, FamilyTree.templates = {}, FamilyTree.templates.base = { defs: `<g transform="matrix(1,0,0,1,0,0)" id="dot"><circle class="bft-fill" cx="0" cy="0" r="5" stroke="#aeaeae" stroke-width="1"></circle></g>
      ...
      return t === FamilyTree.action.exporting ? "" : FamilyTree.t(e.template, false, i).pointer;
      ...
      for (var p in o) {
        ...
        if (h.value = f, h.element = c[p], h.name = u, h.field = p, false !== FamilyTree.events.publish("field", [d, h]) && null != h.value && null != h.value && null != h.element && (!y || y && !FamilyTree.isNEU(h.value))) {
      ...
      if (r !== FamilyTree.action.exporting && !t.isSplit) {
        ...
        if (t.childrenIds.length > 0) {
          if (t.hasPartners) {
            for (var c = false, m = 0; m < t.childrenIds.length; m++) {
              var h = e.getNode(t.childrenIds[m]);
              !h || h.parentPartner || h.isPartner || (c = true);
            }
            if (!c) return "";
          }
      ...
      for (g = 0; g < e.children.length; g++) {
        var v, T = e.children[g], b = r[f][T.sl], F = { xa: 0, ya: 0, xb: 0, yb: 0, xc: 0, yc: 0, xd: 0, yd: 0, x: 0, y: 0, rotate: 0 }, x = (d = FamilyTree.t(T.templateName, T.min, i)).link;
        ...
        else if (-1 != x.indexOf("{rounded}")) if (F.xa == F.xb && F.xa == F.xc && F.xa == F.xd || F.ya == F.yb && F.ya == F.yc && F.ya == F.yd) v = "M" + F.xa + "," + F.ya + " L" + F.xd + "," + F.yd, x = x.replaceAll("{rounded}", v);
        ...
        for (var L in t.config.linkBinding) {
          ...
          if (M) {
            var O = M[E];
            N.value = O, N.element = d[L], N.name = E, false !== FamilyTree.events.publish("label", [t, N]) && (FamilyTree.isNEU(N.value) || FamilyTree.isNEU(N.element) || (A += N.element.replace("{val}", N.value)));
          }
        }
        if ("" != A) {
          var U = F.x, B = F.y;
      ...
      if (FamilyTree._isMoved(i) && !FamilyTree._isMoved(t)) {
        ...
        return FamilyTree.roundPathCorners(o, FamilyTree.LINK_ROUNDED_CORNERS, false);
      }
      if (!FamilyTree._isMoved(i) && FamilyTree._isMoved(t)) {
        var l = false;
        o = [];
        switch (n) {
          case FamilyTree.orientation.top:
          case FamilyTree.orientation.top_left:
            if (r.ya + a / 2 > r.yb) l = true, s = r.xa < r.xd ? t.x + t.w + a / 2 : t.x - a / 2, d = t.y + t.h + a;
            else {
              if (r.yb + a / 2 < r.yd) return null;
              s = r.xa < r.xd ? i.x - a / 2 : i.x + i.w + a / 2, d = i.y - a / 2;
            }
          ...
          case FamilyTree.orientation.bottom:
          case FamilyTree.orientation.bottom_left:
            if (r.ya - a / 2 < r.yb) l = true, s = r.xa < r.xd ? t.x + t.w + a / 2 : t.x - a / 2, d = t.y - a;
            else {
              if (r.yb - a / 2 > r.yd) return null;
              s = r.xa < r.xd ? i.x - a / 2 : i.x + i.w + a / 2, d = i.y + i.h + a / 2;
            }
          ...
          case FamilyTree.orientation.right:
          case FamilyTree.orientation.right_top:
            if (r.xa - a / 2 < r.xb) l = true, d = r.ya < r.yd ? t.y + t.h + a / 2 : t.y - a / 2, s = t.x - a;
            else {
              if (r.xb - a / 2 > r.xd) return null;
              d = r.ya < r.yd ? i.y - a / 2 : i.y + i.h + a / 2, s = i.x + i.w + a / 2;
            }
          ...
          case FamilyTree.orientation.left:
          case FamilyTree.orientation.left_top:
            if (r.xa + a / 2 > r.xb) l = true, d = r.ya < r.yd ? t.y + t.h + a / 2 : t.y - a / 2, s = t.x + t.w + a;
            else {
              if (r.xb + a / 2 < r.xd) return null;
              d = r.ya < r.yd ? i.y - a / 2 : i.y + i.h + a / 2, s = i.x - a / 2;
            }
      ...
      if ((this.config.mouseScrool == FamilyTree.action.xScroll || this.config.mouseScrool == FamilyTree.action.scroll) && this.bar) {
        ...
        !function(e2, r2, a) {
          ...
          function o() {
            n = true;
            var e3 = (t.position - t.bar.scrollLeft) / a;
            if (e3 > 0) e3++;
            else {
              if (0 == e3) return void (n = false);
              e3--;
            }
            Math.ceil(t.bar.scrollLeft) == Math.ceil(t.position) ? n = false : (t.bar.scrollLeft += e3, l(o));
          }
          e2.addEventListener("wheel", function(e3) {
            if (e3.ctrlKey) return;
            var a2 = 0;
            if (t.config.mouseScrool == FamilyTree.action.xScroll) (a2 = e3.deltaX || e3.wheelDeltaX) || (a2 = e3.deltaY || e3.wheelDeltaY);
            else if (t.config.mouseScrool == FamilyTree.action.scroll && !(a2 = i || !e3.shiftKey ? e3.deltaX || e3.wheelDeltaX : e3.deltaY || e3.wheelDeltaY)) return;
            a2 = -a2, a2 = Math.max(-1, Math.min(1, a2)), t.position += -a2 * r2;
            var l2 = parseFloat(t.innerBar.clientWidth) - parseFloat(t.bar.clientWidth);
            t.position < 0 && (t.position = 0);
            t.position > l2 && (t.position = l2);
            n || o();
          }, { passive: true });
          var l = window.requestAnimationFrame || window.webkitRequestAnimationFrame || window.mozRequestAnimationFrame || window.oRequestAnimationFrame || window.msRequestAnimationFrame || function(e3) {
            setTimeout(e3, 20);
          };
        }(e, r.speed, r.smooth);
      }
      ...
      if (this.config.showXScroll === FamilyTree.scroll.visible || this.config.mouseScrool === FamilyTree.action.scroll || this.config.mouseScrool === FamilyTree.action.xScroll) {
        ...
        this.requestParams();
        this.innerBar.innerHTML = "&nbsp", Object.assign(this.bar.style, { position: "absolute", left: 0, bottom: 0, width: e + "px", "overflow-x": "scroll", height: "20px" }), this.element.appendChild(this.bar), this.bar.appendChild(this.innerBar), this.bar.addEventListener("scroll", function() {
          if (this.ignore) this.ignore = false;
          else {
            var e2 = t.requestParams(), i = (parseFloat(t.innerBar.clientWidth) - parseFloat(t.bar.clientWidth)) / 100, r = this.scrollLeft / i, a = (e2.boundary.right - e2.boundary.left) / 100;
            e2.viewBox[0] = r * a + e2.boundary.left, t.onSetViewBoxCallback(e2.viewBox), clearTimeout(this._timeout), this._timeout = setTimeout(function() {
              t.onDrawCallback();
            }, 500);
          }
        });
      ...
      if (this.bar) {
        ...
        this.bar.ignore = true, this.bar.scrollLeft = n, this.position = this.bar.scrollLeft, this.bar.style.visibility = a <= 0 ? "hidden" : "", this.config.showXScroll !== FamilyTree.scroll.visible && (this.bar.style.visibility = "hidden"), FamilyTree.events.publish("change", [this, { isScrollBarVisible: "hidden" != this.bar.style.visibility }]);
      }
      ...
      if ((this.config.mouseScrool == FamilyTree.action.yScroll || this.config.mouseScrool == FamilyTree.action.scroll) && this.bar) {
        ...
        !function(e2, r2, a) {
          ...
          function o() {
            n = true;
            var e3 = (t.position - t.bar.scrollTop) / a;
            if (e3 > 0) e3++;
            else {
              if (0 == e3) return void (n = false);
              e3--;
            }
            Math.ceil(t.bar.scrollTop) == Math.ceil(t.position) ? n = false : (t.bar.scrollTop += e3, l(o));
          }
          e2.addEventListener("wheel", function(e3) {
            if (e3.ctrlKey) return;
            var a2 = 0;
            if (t.config.mouseScrool == FamilyTree.action.yScroll) (a2 = e3.deltaY || e3.wheelDeltaY) || (a2 = e3.deltaX || e3.wheelDeltaX);
            else if (t.config.mouseScrool == FamilyTree.action.scroll && !(a2 = i || !e3.shiftKey ? e3.deltaY || e3.wheelDeltaY : e3.deltaX || e3.wheelDeltaX)) return;
            a2 = -a2, a2 = Math.max(-1, Math.min(1, a2)), t.position += -a2 * r2;
            var l2 = parseFloat(t.innerBar.clientHeight) - parseFloat(t.bar.clientHeight);
            t.position < 0 && (t.position = 0);
            t.position > l2 && (t.position = l2);
            n || o();
          }, { passive: true });
      ...
      if (this.config.showYScroll === FamilyTree.scroll.visible || this.config.mouseScrool === FamilyTree.action.scroll || this.config.mouseScrool === FamilyTree.action.yScroll) {
        var t = this;
        this.bar && this.bar.parentNode && this.bar.parentNode.removeChild(this.bar), this.bar = document.createElement("div"), this.innerBar = document.createElement("div"), this.innerBar.innerHTML = "&nbsp", Object.assign(this.bar.style, { position: "absolute", right: 0, bottom: 0, height: e + "px", "overflow-y": "scroll", width: "20px" }), this.element.appendChild(this.bar), this.bar.appendChild(this.innerBar), this.bar.addEventListener("scroll", function() {
          if (this.ignore) this.ignore = false;
          else {
            var e2 = t.requestParams(), i = (parseFloat(t.innerBar.clientHeight) - parseFloat(t.bar.clientHeight)) / 100, r = this.scrollTop / i, a = (e2.boundary.bottom - e2.boundary.top) / 100;
            e2.viewBox[1] = r * a + e2.boundary.top, t.onSetViewBoxCallback(e2.viewBox), clearTimeout(this._timeout), this._timeout = setTimeout(function() {
              t.onDrawCallback();
            }, 500);
          }
        });
      ...
      if (this.bar) {
        ...
        this.bar.ignore = true, this.bar.scrollTop = n, this.position = this.bar.scrollTop, this.bar.style.visibility = a <= 0 ? "hidden" : "", this.config.showYScroll !== FamilyTree.scroll.visible && (this.bar.style.visibility = "hidden"), FamilyTree.events.publish("change", [this, { isScrollBarVisible: "hidden" != this.bar.style.visibility }]);
      }
      ...
      true === e ? (a[2] = a[2] / FamilyTree.SCALE_FACTOR, a[3] = a[3] / FamilyTree.SCALE_FACTOR) : false === e ? (a[2] = a[2] * FamilyTree.SCALE_FACTOR, a[3] = a[3] * FamilyTree.SCALE_FACTOR) : (a[2] = a[2] / e, a[3] = a[3] / e), t || (t = [50, 50]), a[0] = n[0] - (a[2] - o) / (100 / t[0]), a[1] = n[1] - (a[3] - l) / (100 / t[1]);
      var s = this.getScale(a);
      if (a[2] = this.width() / s, a[3] = this.height() / s, true === e && s < this.config.scaleMax || false === e && s > this.config.scaleMin || 0 != e && 1 != e && s < this.config.scaleMax && s > this.config.scaleMin) {
        ...
        i ? (clearTimeout(d._timeout), FamilyTree.animate(this.getSvg(), { viewbox: this.getViewBox() }, { viewbox: a }, this.config.anim.duration, this.config.anim.func, function() {
          clearTimeout(d._timeout), d._timeout = setTimeout(function() {
            d._draw(true, FamilyTree.action.zoom, null, r);
          }, 500);
      ...
      l.value = t.format, s.value = t.landscape, d.value = t.scale, c.value = t.margin, m.value = t.header, h.value = t.footer, FamilyTree.animate(e.element.querySelector("#bft-ppdf-btns"), { margin: [0, 0, 0, -250] }, { margin: [0, 0, 0, 0] }, 300, FamilyTree.anim.outSin, function() {
        ...
        clearTimeout(a), a = setTimeout(function() {
          FamilyTree.animate(e.element.querySelector("#bft-ppdf-content"), { opacity: 1 }, { opacity: 0 }, 300, FamilyTree.anim.inSin, function() {
            ...
            var i2 = c.value.split(",");
            if (4 == i2.length) {
              for (var r2 = 0; r2 < i2.length; r2++) i2[r2] = parseInt(i2[r2]);
              t.margin = i2, e.exportPDF(t, FamilyTree.pdfPrevUI._handler);
            }
          });
        }, 1e3);
      ...
      for (var s = l.querySelector("svg"), d = e.element.querySelector("#bft-ppdf-content"), c = 0; c < a.length; c++) {
        ...
        Object.assign(m.style, { display: "block", margin: "10px auto", border: "1px solid #eeeeee", "box-shadow": "0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19)" }), d.appendChild(m), s && s.style.backgroundColor ? m.style.backgroundColor = s.style.backgroundColor : m.style.backgroundColor = "#fff";
      ...
      for (var i = "", r = 0; r < this.config.clinks.length; r++) {
        let _2 = function(e2, t2, i2) {
          null == i2 && (i2 = 1);
          var r2 = t2.x - e2.x, n2 = t2.y - e2.y, o2 = Math.sqrt(Math.pow(t2.x - e2.x, 2) + Math.pow(t2.y - e2.y, 2)) / 3;
          return o2 = o2 / (Math.sqrt(r2 * r2 + n2 * n2) * i2) * FamilyTree.clinkCurve(a), { x: e2.x + r2 / 2 - n2 * o2, y: e2.y + n2 / 2 + r2 * o2 };
        };
        var _ = _2;
      ...
      function n(t2, n2, o2) {
        var s2 = [], d2 = null, c = "left", m = t2.lcn ? t2.lcn : "base", h = e._layoutConfigs[m];
        switch (h.orientation) {
          ...
          case FamilyTree.orientation.right:
          case FamilyTree.orientation.right_top:
            c = "top", n2.y > t2.y && (c = "bottom");
        }
        var p = FamilyTree.t(t2.templateName, t2.min, r), f = h.levelSeparation;
        t2.parent && t2.parent.layout && (f = h.mixedHierarchyNodesSeparation);
        var u = { p: t2.x + t2.w / 2 + p.expandCollapseSize, q: t2.y, r: t2.x + t2.w / 2 + p.expandCollapseSize, s: a.minY + f };
        if (t2.sl == n2.sl) switch (d2 = n2, h.orientation) {
          case FamilyTree.orientation.top:
          case FamilyTree.orientation.top_left:
            s2.push([u.p, u.q]), s2.push([u.p, u.q - f / 3]), p = FamilyTree.t(d2.templateName, d2.min, r), s2.push([d2.x + d2.w / 2 + p.expandCollapseSize, s2[s2.length - 1][1]]), s2.push([s2[s2.length - 1][0], d2.y]);
            break;
          case FamilyTree.orientation.bottom:
          case FamilyTree.orientation.bottom_left:
            u.q = t2.y + t2.h, u.s = a.maxY - f, s2.push([u.p, u.q]), s2.push([u.r, t2.y + t2.h + f / 3]), p = FamilyTree.t(d2.templateName, d2.min, r), s2.push([d2.x + d2.w / 2 + p.expandCollapseSize, s2[s2.length - 1][1]]), s2.push([s2[s2.length - 1][0], d2.y + d2.h]);
            break;
          case FamilyTree.orientation.left:
          case FamilyTree.orientation.left_top:
            u.p = t2.x, u.q = t2.y + t2.h / 2 + p.expandCollapseSize, u.r = a.minX - f, u.s = t2.y + t2.h / 2 + p.expandCollapseSize, s2.push([u.p, u.q]), s2.push([t2.x - f / 3, u.q]), p = FamilyTree.t(d2.templateName, d2.min, r), s2.push([s2[s2.length - 1][0], d2.y + d2.h / 2 + p.expandCollapseSize]), s2.push([d2.x, s2[s2.length - 1][1]]);
            break;
          case FamilyTree.orientation.right:
          case FamilyTree.orientation.right_top:
            u.p = t2.x + t2.w, u.q = t2.y + t2.h / 2 + p.expandCollapseSize, u.r = a.maxX + f, u.s = t2.y + t2.h / 2 + p.expandCollapseSize, s2.push([u.p, u.q]), s2.push([t2.x + t2.w + f / 3, u.q]), p = FamilyTree.t(d2.templateName, d2.min, r), s2.push([s2[s2.length - 1][0], d2.y + d2.h / 2 + p.expandCollapseSize]), s2.push([d2.x + d2.w, s2[s2.length - 1][1]]);
        }
        else {
          switch (h.orientation) {
            case FamilyTree.orientation.top:
            case FamilyTree.orientation.top_left:
              s2.push([u.p, u.q]), s2.push([u.r, t2.y - f / 3]);
              break;
            case FamilyTree.orientation.bottom:
            case FamilyTree.orientation.bottom_left:
              u.q = t2.y + t2.h, u.s = a.maxY - f, s2.push([u.p, u.q]), s2.push([u.r, t2.y + t2.h + f / 3]);
              break;
            case FamilyTree.orientation.left:
            case FamilyTree.orientation.left_top:
              u.p = t2.x, u.q = t2.y + t2.h / 2 + p.expandCollapseSize, u.r = a.minX - f, u.s = t2.y + t2.h / 2 + p.expandCollapseSize, s2.push([u.p, u.q]), s2.push([t2.x - f / 3, u.q]);
              break;
            case FamilyTree.orientation.right:
            case FamilyTree.orientation.right_top:
              u.p = t2.x + t2.w, u.q = t2.y + t2.h / 2 + p.expandCollapseSize, u.r = a.maxX + f, u.s = t2.y + t2.h / 2 + p.expandCollapseSize, s2.push([u.p, u.q]), s2.push([t2.x + t2.w + f / 3, u.q]);
          }
          for (var y = t2, g = t2; g.parent; ) g = g.parent;
          for (; null == d2; ) {
            var v = false, T = y.parent, b = T.leftNeighbor, F = T.rightNeighbor;
            if (T.id == n2.id ? d2 = T : FamilyTree._intersects(T, u, h) && (u = FamilyTree._addPoint(T, s2, h, u, c), v = true), T.id != n2.id) {
              for (; b; ) {
                if (b.id == n2.id) {
                  d2 = b;
                  break;
                }
                FamilyTree._intersects(b, u, h) && (u = FamilyTree._addPoint(b, s2, h, u, c), v = true), b = b.leftNeighbor;
              }
              for (; F; ) {
                if (F.id == n2.id) {
                  d2 = F;
                ...
                FamilyTree._intersects(F, u, h) && (u = FamilyTree._addPoint(F, s2, h, u, c), v = true), F = F.rightNeighbor;
              }
            }
            if (!v) {
              var x = s2[s2.length - 1][0], _ = 0;
              if (T.parent) {
                ...
                switch (h.orientation) {
                  ...
                  case FamilyTree.orientation.left:
                  case FamilyTree.orientation.left_top:
                    x = w.maxX + f * (2 / 3), _ = s2[s2.length - 1][1];
                    break;
                  case FamilyTree.orientation.right:
                  case FamilyTree.orientation.right_top:
                    x = w.minX - f * (2 / 3), _ = s2[s2.length - 1][1];
                }
              }
              s2.push([x, _]);
            }
          ...
          switch (p = FamilyTree.t(d2.templateName, d2.min, r), s2.splice(s2.length - 1, 1), h.orientation) {
            case FamilyTree.orientation.top:
            case FamilyTree.orientation.top_left:
              s2.push([d2.x + d2.w / 2 + p.expandCollapseSize, s2[s2.length - 1][1]]), s2.push([s2[s2.length - 1][0], d2.y + d2.h]);
              break;
            case FamilyTree.orientation.bottom:
            case FamilyTree.orientation.bottom_left:
              s2.push([d2.x + d2.w / 2 + p.expandCollapseSize, s2[s2.length - 1][1]]), s2.push([s2[s2.length - 1][0], d2.y]);
              break;
            case FamilyTree.orientation.left:
            case FamilyTree.orientation.left_top:
              s2.push([s2[s2.length - 1][0], d2.y + d2.h / 2 + p.expandCollapseSize]), s2.push([d2.x + d2.w, s2[s2.length - 1][1]]);
              break;
            case FamilyTree.orientation.right:
            case FamilyTree.orientation.right_top:
              s2.push([s2[s2.length - 1][0], d2.y + d2.h / 2 + p.expandCollapseSize]), s2.push([d2.x, s2[s2.length - 1][1]]);
          }
        }
        var k = l.template;
        k || (k = "orange");
        ...
        switch ((p = FamilyTree.slinkTemplates[k]).labelPosition) {
          case "start":
            ...
            break;
          case "middle":
            var N = Math.ceil(s2.length / 2);
            S = s2[N], C = s2[N - 1], I = { x: (S[0] + C[0]) / 2, y: (S[1] + C[1]) / 2 };
            break;
          case "end":
            I = { x: s2[s2.length - 2][0], y: s2[s2.length - 2][1] };
        }
        o2 && (s2 = s2.reverse()), s2[0].unshift("M");
        for (var A = 1; A < s2.length; A++) s2[A].unshift("L");
        var L = FamilyTree.roundPathCorners(s2, FamilyTree.LINK_ROUNDED_CORNERS, false);
        if (l.label) {
        ...
        var U = t2.id, B = n2.id;
        o2 && (U = n2.id, B = t2.id), i += ("<g " + FamilyTree.attr.s_link_from + '="{from}" ' + FamilyTree.attr.s_link_to + '="{to}">').replace("{from}", U).replace("{to}", B) + p.link.replaceAll("{d}", L) + '<path stroke="transparent" stroke-width="15" fill="none" d="' + L + '" />', i += FamilyTree.grCloseTag;
      }
      for (var o = 0; o < this.config.slinks.length; o++) {
        var l = this.config.slinks[o], s = e.getNode(l.from), d = e.getNode(l.to);
        s && d && -1 != t.res.visibleNodeIds.indexOf(d.id) && -1 != t.res.visibleNodeIds.indexOf(s.id) && (s.sl >= d.sl ? n(s, d, false) : n(d, s, true));
      }
      t.content += i;
      ...
      if (this.instance.config.undoRedoStorageName) {
        ...
        if (false !== FamilyTree.events.publish("change", [this, t])) {
      ...
      if (e.config.miniMap) {
        if (e.manager.action != FamilyTree.action.move) {
          ...
          var r, a, n, o, l = e.element.querySelector('[data-id="mini-map-focus"]'), s = false, d = null;
          l.onmousedown = function(e2) {
            var t2, n2, o2, d2 = l.getBoundingClientRect(), c2 = d2.left, m = d2.top;
            if (r = parseInt(e2.clientX - c2), a = parseInt(e2.clientY - m), t2 = a, n2 = (r - FamilyTree.miniMap._settings._translateX) / FamilyTree.miniMap._settings._scale, o2 = (t2 - FamilyTree.miniMap._settings._translateY) / FamilyTree.miniMap._settings._scale, n2 > i[0] && n2 < i[0] + i[2] && o2 > i[1] && o2 < i[1] + i[3]) return e2.preventDefault(), e2.stopPropagation(), void (s = true);
          }, l.onmousemove = function(t2) {
            if (s) {
              t2.preventDefault(), t2.stopPropagation(), FamilyTree.miniMap._mouseMove = true;
              var c2 = l.getBoundingClientRect(), m = c2.left, h = c2.top;
              n = parseInt(t2.clientX - m), o = parseInt(t2.clientY - h);
              ...
              i[0] = p + i[0], i[1] = f + i[1], e.setViewBox(i), d && (clearTimeout(d), d = null), d = setTimeout(function() {
                e._draw(true, FamilyTree.action.move);
              }, 300), FamilyTree.miniMap._drawRectSelectorCanvas(e, i), r = n, a = o;
            }
          }, l.onmouseup = function(e2) {
            s && (e2.preventDefault(), e2.stopPropagation(), s = false);
          }, l.onmouseout = function(e2) {
            s && (e2.preventDefault(), e2.stopPropagation(), s = false, FamilyTree.miniMap._mouseMove = false);
          }, l.onclick = function(t2) {
            if (t2.preventDefault(), t2.stopPropagation(), FamilyTree.miniMap._mouseMove) FamilyTree.miniMap._mouseMove = false;
            else {
              var r2 = l.getBoundingClientRect(), a2 = r2.left, s2 = r2.top;
              n = parseInt(t2.clientX - a2), o = parseInt(t2.clientY - s2);
              var c2 = n / FamilyTree.miniMap._settings._scale, m = o / FamilyTree.miniMap._settings._scale;
              i[0] = c2 - (i[0] + i[2] - i[0]) / 2 - FamilyTree.miniMap._settings._translateX / FamilyTree.miniMap._settings._scale, i[1] = m - (i[1] + i[3] - i[1]) / 2 - FamilyTree.miniMap._settings._translateY / FamilyTree.miniMap._settings._scale, e.setViewBox(i), d && (clearTimeout(d), d = null), d = setTimeout(function() {
                e._draw(true, FamilyTree.action.move);
    ...
    }), FamilyTree.miniMap = {}, FamilyTree.miniMap._settings = { _translateX: 0, _translateY: 0, _scale: 1 }, FamilyTree.miniMap._drawMainCanvas = function(e) {
      var t = e.element.querySelector('[data-id="mini-map-main"]'), i = t.getContext("2d");
      FamilyTree.miniMap._initCtx(e, t, 1);
      var r = 0, a = [];
      !function e2(t2, n) {
        if (Array.isArray(n)) for (var o = 0; o < n.length; o++) e2(t2, n[o]);
        else {
          ...
          for (o = 0; o < n.stChildrenIds.length; o++) r++, a.includes(n.id) || (1 == r ? i.fillStyle = FamilyTree.miniMap.colors[0] : 2 == r ? i.fillStyle = FamilyTree.miniMap.colors[1] : 3 == r && (i.fillStyle = FamilyTree.miniMap.colors[2]), i.beginPath(), i.fillRect(n.x, n.y, n.w, n.h), i.strokeRect(n.x, n.y, n.w, n.h), a.push(n.id)), e2(t2, t2.getNode(n.stChildrenIds[o])), r--;
          for (o = 0; o < n.childrenIds.length; o++) e2(t2, t2.getNode(n.childrenIds[o]));
        }
      }(e, e.roots);
      ...
      if (!e.element.querySelector('[data-id="mini-map"]')) {
        ...
        var s = function(t2, i2) {
          e.__mouseScrollHandler(r, i2);
        };
        e._addEvent(r, "DOMMouseScroll", s), e._addEvent(r, "mousewheel", s);
        var d = 0, c = 0, m = function(e2) {
          FamilyTree.miniMap._mouseMove = true;
          var t2 = e2.clientX - d, i2 = e2.clientY - c;
          if (!FamilyTree.isNEU(r.style.left)) {
            var a2 = parseFloat(r.style.left) + t2;
            r.style.left = `${a2}px`;
          }
          if (!FamilyTree.isNEU(r.style.right)) {
            var n2 = parseFloat(r.style.right) - t2;
            r.style.right = `${n2}px`;
          }
          if (!FamilyTree.isNEU(r.style.bottom)) {
            var o2 = parseFloat(r.style.bottom) - i2;
            r.style.bottom = `${o2}px`;
          }
          if (!FamilyTree.isNEU(r.style.top)) {
            var l2 = parseFloat(r.style.top) + i2;
            r.style.top = `${l2}px`;
          }
          d = e2.clientX, c = e2.clientY;
        }, h = function() {
          document.removeEventListener("mousemove", m), document.removeEventListener("mouseup", h);
        };
        FamilyTree.miniMap.draggable && r.addEventListener("mousedown", function(e2) {
          d = e2.clientX, c = e2.clientY, document.addEventListener("mousemove", m), document.addEventListener("mouseup", h);
        });
      }
    }, FamilyTree.miniMap.colors = ["#E0E0E0", "#BDBDBD", "#9E9E9E", "#757575"], FamilyTree.miniMap.selectorBackgroundColor = "white", FamilyTree.miniMap.backgroundColor = "white", FamilyTree.miniMap.focusStroke = "#f57c00", FamilyTree.miniMap.opacity = 0.4, FamilyTree.miniMap.border = "1px solid #aeaeae", FamilyTree.miniMap.width = 250, FamilyTree.miniMap.height = 140, FamilyTree.miniMap.padding = 5, FamilyTree.miniMap.position = { top: void 0, left: "padding", right: void 0, bottom: "padding" }, FamilyTree.miniMap.draggable = true, FamilyTree._search = {}, FamilyTree._search.search = function(e, t, i, r, a, n, o) {
      var l = [], s = t.toLowerCase(), d = s.split(" ");
      if (o && d.length > 1) {
        var c = d[0];
        o[c] && (i = [o[c]], d = (s = s.replace(c, "").trim()).split(" "));
      }
      d = d.filter(function(e2, t2, i2) {
        return i2.indexOf(e2) === t2;
      });
      ...
      return l.sort(function(e2, t2) {
        return e2.__score < t2.__score ? 1 : e2.__score > t2.__score ? -1 : 0;
      }), l;
      ...
      n.sort(function(e2, t2) {
        return e2.start < t2.start ? -1 : e2.start > t2.start ? 1 : 0;
      });
      ...
      return i.sort(function(e2, t2) {
        return e2.length < t2.length ? 1 : e2.length > t2.length || e2.start < t2.start ? -1 : e2.start > t2.start ? 1 : 0;
      }), i = i.filter(function(e2) {
        for (var t2 = false, r2 = 0; r2 < i.length; r2++) {
          var a2 = i[r2].start, n2 = i[r2].start + i[r2].length - 1, o = e2.start, l = e2.start + e2.length - 1;
          if (a2 == o && n2 == l) {
            t2 = false;
            break;
          }
      ...
      if (e.config.state) {
        var i = [], r = [];
        !function e2(t2) {
          if (Array.isArray(t2)) for (var a = 0; a < t2.length; a++) e2(t2[a]);
          else {
            ("string" != typeof t2.id || "string" == typeof t2.id && -1 == t2.id.indexOf("split") && -1 == t2.id.indexOf("mirror")) && (i.push(t2.id), 1 == t2.min && r.push(t2.id));
            for (a = 0; a < t2.stChildren.length; a++) e2(t2.stChildren[a]);
            for (a = 0; a < t2.children.length; a++) e2(t2.children[a]);
          }
      ...
      if (l && !FamilyTree.isNEU(a) && 0 != a.length) {
        var s = FamilyTree.state._buildStateNames(l.name), d = { roots: e, scale: Math.min(t / r[2], i / r[3]), x: r[0], y: r[1], exp: a, min: n, adjustify: o };
        ...
        l.writeToIndexedDB && (d.id = l.name, FamilyTree.idb.put(d, function(e2) {
          0 == e2 && console.error("Cannot write row - " + l.name);
      ...
      if (e) {
        ...
        e.readFromIndexedDB && FamilyTree.idb.read(e.name, function(a2, n2) {
          if (0 == a2) console.error("Cannot read from - " + e.name), r(null);
          else if (null == a2) r(null);
          else {
            var o2 = [];
            o2[0] = n2.x, o2[1] = n2.y, o2[2] = t / n2.scale, o2[3] = i / n2.scale, n2.vb = o2, r(n2);
          }
        });
      } else r(null);
      ...
      try {
        ...
        i.has(t.paramScale) && i.delete(t.paramScale), i.has(t.paramX) && i.delete(t.paramX), i.has(t.paramY) && i.delete(t.paramY), i.has(t.paramExp) && i.delete(t.paramExp), i.has(t.paramRoots) && i.delete(t.paramRoots), i.has(t.paramMin) && i.delete(t.paramMin), i.has(t.paramAdjustify) && i.delete(t.paramAdjustify), window.history.replaceState(null, null, "?" + i), FamilyTree.idb.delete(e, function(t2) {
          0 == t2 && console.error("Cannot delete row - " + e);
        });
      } catch {
      }
      ...
      if (n || o) {
        ...
        if (l && (null != l.timer && clearInterval(l.timer), null != l.timerBack && clearInterval(l.timerBack), o.setAttribute("transform", "matrix(" + l.transformStart.toString() + ")"), FamilyTree._magnify[e] = null), i) o = o.cloneNode(true), this.getSvg().appendChild(o);
      ...
      if (r) {
        ...
        r.timerBack = FamilyTree.animate(r.nodeElement, { transform: a }, { transform: r.transformStart }, t.duration, t.func, function(e2) {
          var t2 = e2[0].getAttribute(FamilyTree.attr.node_id);
          FamilyTree._magnify[t2] && FamilyTree._magnify[t2].front && (e2[0].parentNode.removeChild(e2[0]), FamilyTree._magnify[t2] = null), i && i(e2[0]);
        });
      }
      ...
      if (i) {
        ...
        if (false !== FamilyTree.events.publish("key-down", [this, n]) && a) {
      ...
      var n = "";
      return t.btn && (n = `<a href="#" data-input-btn="" class="bft-link bft-link-bft-button">${t.btn}</a>`), { html: `<div class="bft-form-field" style="min-width: ${i};">
      ...
      return { html: `<div class="bft-form-field"  style="min-width: ${i};" >
      ...
      var a = FamilyTree.elements._vidrf(e, t, r);
      return a.doNotRender ? { html: "" } : { html: `<div class="bft-form-field" style="min-width: ${i};">
                    <div class="bft-input" data-bft-input="" ${a.disabledAttribute} ${a.vlidators}>
                        <label for="${a.id}">${FamilyTree._escapeGreaterLessSign(a.label)}</label>
                        <select data-binding="${FamilyTree._escapeDoubleQuotes(a.binding)}" ${a.readOnlyAttribute} id="${a.id}" name="${a.id}">
                            ${function() {
        for (var e2 = "", t2 = 0; t2 < a.options.length; t2++) {
          var i2 = a.options[t2];
          e2 += `<option ${i2.value == a.value ? "selected" : ""} value="${FamilyTree._escapeDoubleQuotes(i2.value)}">${FamilyTree._escapeGreaterLessSign(i2.text)}</option>`;
        }
        return e2;
      }()}                           
                        </select>
      ...
      return a.doNotRender ? { html: "" } : { html: `<div class="bft-form-field" style="min-width: ${i};">
        ...
        for (var e2 = "", t2 = 0; t2 < a.options.length; t2++) {
          var i2 = a.options[t2];
          e2 += `<option ${a.value.includes(i2.value) ? "selected" : ""} value="${FamilyTree._escapeDoubleQuotes(i2.value)}">${FamilyTree._escapeGreaterLessSign(i2.text)}</option>`;
        }
        return e2;
      }()}                           
                        </select>
      ...
      if (r.id = FamilyTree.elements.generateId(), r.disabledAttribute = i ? "data-bft-input-disabled" : "", r.readOnlyAttribute = i ? "readonly" : "", r.id = r.id, i && FamilyTree.isNEU(r.value) && (r.doNotRender = true), i && "photo" == t.binding && (r.id = null, r.doNotRender = true), r.binding = t.binding, r.label = t.label, r.vlidators = "", t.vlidators) for (var n in t.vlidators) r.vlidators += `data-v-${n}="${t.vlidators[n]}" `;
      return r;
      ...
      for (var i = 0; i < t.length; i++) {
        ...
        n && (a.value || "select-one" == a.type && a.selectedOptions && a.selectedOptions.length && "" == a.selectedOptions[0].value && a.selectedOptions[0].innerHTML) && n.classList.add("hasval"), "checkbox" != a.type.toLowerCase() && a.addEventListener("focus", function() {
          ...
          var e2 = this.parentNode.querySelector("label");
          e2.classList.add("focused");
          var t2 = e2.querySelector(".bft-validation-error-message");
      ...
      return a && "" == t.value ? (i.innerHTML += '<span class="bft-validation-error-message">&nbsp;' + a + "</span>", t.classList.add("bft-validation-error"), false) : n && !FamilyTree.input.validatePassword(t.value) ? (i.innerHTML += '<span class="bft-validation-error-message">&nbsp;' + n + "</span>", t.classList.add("bft-validation-error"), false) : o && !FamilyTree.input.isValidEmail(t.value) ? (i.innerHTML += '<span class="bft-validation-error-message">&nbsp;' + o + "</span>", t.classList.add("bft-validation-error"), false) : !(l && !FamilyTree.input.isValidEmails(t.value)) || (i.innerHTML += '<span class="bft-validation-error-message">&nbsp;' + l + "</span>", t.classList.add("bft-validation-error"), false);
    }, FamilyTree.input.validateAndGetData = function(e) {
      for (var t = e.querySelectorAll("[data-bft-input]"), i = true, r = 0; r < t.length; r++) {
        var a = t[r];
        FamilyTree.input.validate(a) || (i = false);
      }
      if (!i) return false;
      ...
      for (r = 0; r < n.length; r++) {
        ...
        if ("checkbox" == l.type.toLowerCase()) o[s] = l.checked;
          ...
          o[s] = Array.from(d).map(({ value: e2 }) => e2);
        } else o[s] = l.value;
      }
      return o;
      ...
      if (e) for (var t = e.split(","), i = 0; i < t.length; i++) {
        var r = t[i].trim();
        if (!FamilyTree.input.isValidEmail(r)) return false;
      }
      return true;
      ...
      if (this._tree_menu_temp) {
        ...
        if (this.manager.oldNodes = this.nodes, this.nodes = i.nodes, this.manager.maxX = i.maxX, this.manager.maxY = i.maxY, this.manager.minX = i.minX, this.manager.minY = i.minY, this.manager.roots = i.roots, this.manager.nodes = i.nodes, this.manager.rootList = i.rootList, this.manager.visibleNodeIds = i.visibleNodeIds, this.manager.bordersByRootIdAndLevel = i.bordersByRootIdAndLevel, this.config.roots = i.config.roots, this.config.nodes = i.config.nodes, this._tree_menu_temp = null, e) {
          var r = { id: i.id, animFromClickedNode: false };
          this._draw(true, FamilyTree.action.update, r, function() {
            t && t();
          });
        }
      }
      ...
      if ("male" == c.gender ? (f.templateName = "wife", f._ft_data.gender = "female") : "female" == c.gender && (f.templateName = "husband", f._ft_data.gender = "male"), c.pids.push(f.id), m.push(f), c.pids) for (s = 0; s < c.pids.length; s++) {
        ...
        } else m.push({ id: "_ft_son_" + s, stpid: "_ft_child_group_" + s, templateName: "son", _ft_method: "addChildNode", _ft_data: { mid: e, fid: c.pids[s], gender: "male" } }), m.push({ id: "_ft_daughter_" + s, stpid: "_ft_child_group_" + s, templateName: "daughter", _ft_method: "addChildNode", _ft_data: { mid: e, fid: c.pids[s], gender: "female" } });
      ...
      var x = { id: e, treeMenuMode: true };
      this._draw(false, FamilyTree.action.update, x, function() {
      ...
      if (e instanceof FamilyTree.editUI && e.obj._tree_menu_temp) return false;
      ...
      if (e instanceof FamilyTree) {
        ...
        if (i._ft_method) return "addParentNode" == i._ft_method ? e[i._ft_method](i._ft_childId, i._ft_type, i._ft_data, null, true) : "addChildAndPartnerNodes" == i._ft_method ? e[i._ft_method](i._ft_id, i._ft_childData, i._ft_partnerData, null, true) : "addPartnerAndParentNodes" == i._ft_method ? e[i._ft_method](i._ft_id, i._ft_childIds, i._ft_partnerData, null, true) : e[i._ft_method](i._ft_data, null, true), false;
        for (var r = t.event.target; r; ) {
          if (r.getAttribute && (r.hasAttribute("data-ctrl-n-t-menu-id") || r.hasAttribute("data-ctrl-n-t-menu-c"))) {
            ...
            return FamilyTree.isNEU(a) ? e.hideTreeMenu(true) : e.showTreeMenu(a), t.event.stopPropagation(), t.event.preventDefault(), false;
          }
          r = r.parentNode;
        }
      }
      ...
      if (!this.instance.config.filterBy) return false;
      if (FamilyTree.isNEU(e)) return false;
      if (null !== this.filterBy || "object" != typeof this.instance.config.filterBy || Array.isArray(this.instance.config.filterBy) || (this.filterBy = JSON.parse(JSON.stringify(this.instance.config.filterBy))), null != this.filterBy) for (var t in this.filterBy) {
        ...
        if (null != i) {
          ...
          if (null != r) {
            var a = r[i];
            if (null != a && false === a.checked) return true;
          }
        }
      }
      return false;
      ...
      if (this.instance.config.filterBy) {
        ...
        for (var n in e) {
          ...
          for (i = 0; i < this.instance.config.nodes.length; i++) {
            ...
            null != l && (o[l] || (o[l] = { checked: true, text: l }));
          }
        }
        ...
        this.element.innerHTML = `<div>${f}</div>`, this.element.addEventListener("click", function(e2) {
          if (e2.target.hasAttribute("data-filter-close") || e2.target.hasAttribute("data-filter-field")) {
            for (var t2 = e2.target.getAttribute("data-filter-field"), i2 = p.instance.element.querySelectorAll("[data-filter-menu]"), r2 = 0; r2 < i2.length; r2++) i2[r2].style.display = "none";
            var a2 = p.instance.element.querySelectorAll(".filter-field-selected");
            for (r2 = 0; r2 < a2.length; r2++) a2[r2].classList.remove("filter-field-selected");
            var n2 = p.instance.element.querySelector("[data-filter-close]");
            if (n2 && n2.parentNode.removeChild(n2), e2.target.hasAttribute("data-filter-close")) return;
            if (!e2.target.hasAttribute("data-filter-field")) return;
            var o2 = p.instance.element.querySelector(`[data-filter-menu="${t2}"]`);
            if (!o2) {
              var l2 = { name: t2, text: FamilyTree.filterUI.all, value: t2, checked: true, html: `<div>
                        <input data-all type="checkbox" id="${t2}" name="${t2}" checked>
                        <label for="${t2}">${FamilyTree.filterUI.all}</label>
                    </div>` };
              FamilyTree.events.publish("add-item", [p, l2]);
              var s2 = l2.html;
              for (var d2 in p.filterBy[t2]) {
                var c2 = p.filterBy[t2][d2], m2 = c2.text;
                null == m2 && (m2 = d2), l2 = { name: t2, text: m2, value: d2, checked: c2.checked, html: `<div>
                            <input  type="checkbox" id="${t2}_${d2}" name="${d2}" ${c2.checked ? "checked" : ""}>
                            <label for="${t2}_${d2}">${m2}</label>
                        </div>` }, FamilyTree.events.publish("add-item", [p, l2]), s2 += l2.html;
              }
              o2 = document.createElement("div");
              var h2 = FamilyTree.filterUI.textFilterBy;
              o2.innerHTML = `<fieldset>
                                                    <legend>${h2} ${t2}:</legend>
                                                    ${s2}
                                                </fieldset>`, o2.setAttribute("data-filter-menu", t2), o2.classList.add("bft-filter-menu"), e2.target.parentNode.parentNode.appendChild(o2);
              var f2 = o2.querySelectorAll("input");
              for (r2 = 0; r2 < f2.length; r2++) f2[r2].addEventListener("change", function(e3) {
                for (var t3 = e3.target; t3 && !t3.hasAttribute("data-filter-menu"); ) t3 = t3.parentNode;
                if (t3) {
                  var i3 = t3.getAttribute("data-filter-menu");
                  if (e3.target.hasAttribute("data-all")) {
                    for (var r3 = e3.target.parentNode.parentNode.querySelectorAll("input"), a3 = 0; a3 < r3.length; a3++) if (r3[a3] != e3.target) for (var n3 in r3[a3].checked = e3.target.checked, p.filterBy[i3]) p.filterBy[i3][n3].checked = e3.target.checked;
                  } else if (null != p.filterBy[i3][this.name] && (p.filterBy[i3][this.name].checked = this.checked), this.checked) {
                    for (var o3 = p.instance.config.nodes, l3 = 0; l3 < o3.length; l3++) if (o3[l3][i3] == this.name) {
                      for (var s3 = o3[l3]; s3; ) if (FamilyTree.isNEU(s3.stpid)) s3 = FamilyTree.isNEU(s3.pid) ? null : p.instance._get(s3.pid);
                      else if ((s3 = p.instance._get(s3.stpid))[i3]) {
                        var d3 = e3.target.parentNode.parentNode.querySelector('[name="' + s3[i3] + '"]');
                        d3 ? (d3.checked = this.checked, p.filterBy[i3][s3[i3]].checked = this.checked) : console.error('Cannot find element with selector: [name="' + s3[i3] + '"]');
                      }
                    }
                  }
                  p.instance.draw();
            ...
            o2.style.display = "block", e2.target.classList.add("filter-field-selected"), (n2 = document.createElement("div")).classList.add("close"), n2.innerHTML = "x", n2.setAttribute("data-filter-close", ""), e2.target.parentNode.appendChild(n2), FamilyTree.events.publish("show-items", [p, { name: t2 }]);
          }
      ...
      return FamilyTree.events.on(e, t, this._event_id), this;
    }, FamilyTree.filterUI.textFilterBy = "Filter by", FamilyTree.filterUI.all = "[All]", void 0 === FamilyTree && (FamilyTree = {}), void 0 === FamilyTree.remote && (FamilyTree.remote = {}), FamilyTree.LIMIT_NODES = true, FamilyTree.remote._fromResDTO = function(e, t, i, r, a) {
      var n = t[e.id];
    ...
    FamilyTree.remote._toReqDTO = function(e, t) {
      ...
      if (FamilyTree.LIMIT_NODES || (s.l = true), null != FamilyTree.remote._fromReqDTO) FamilyTree.remote._fromReqDTO(s.n, s.r, s.c, function(t2) {
        for (var a2 = 0; a2 < e.length; a2++) FamilyTree.remote._fromResDTO(e[a2], t2, 0, e, r);
        i();
      });
      else {
        s = JSON.stringify(s);
        var d = FamilyTree.localStorage.getItem(s);
        d && (d = JSON.parse(d)), d && !d.limit ? FamilyTree.remote._proceed(e, d, r, i) : FamilyTree.remote._findRegion(function(t2) {
          FamilyTree._ajax(t2, "post", s, "json", function(t3) {
            t3.error ? i(2) : (FamilyTree.remote._proceed(e, t3, r, i), FamilyTree.localStorage.setItem(s, JSON.stringify(t3)));
          });
        });
      }
      ...
      if (t) e(t);
        ...
        for (a = 0; a < i.length; a++) !function() {
          var t2 = "https://" + i[a] + FamilyTree.SERVER_PREFIX, n = r[a];
          n.onreadystatechange = function() {
            if (4 == this.readyState && 200 == this.status) {
              FamilyTree.localStorage.setItem(FamilyTree.FUNC_URL_NAME, t2), e(t2);
              for (var i2 = 0; i2 < r.length; i2++) r[i2].abort();
            }
          }, n.open("GET", t2, true), n.send();
        }();
      }
    };
  }
});
export default require_familytree();
//# sourceMappingURL=@balkangraph_familytree__js.js.map
